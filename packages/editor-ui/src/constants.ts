...
export const bonkxbt_IO_BASE_URL = 'https://api.bonkxbt.io/api/';
export const DOCS_DOMAIN = 'docs.bonkxbt.io';
...
export const NPM_KEYWORD_SEARCH_URL =
	'https://www.npmjs.com/search?q=keywords%3Abonkxbt-community-node-package';
export const bonkxbt_QUEUE_MODE_DOCS_URL = `https://${DOCS_DOMAIN}/hosting/scaling/queue-mode/`;
...
export const CUSTOM_NODES_DOCS_URL = `https://${DOCS_DOMAIN}/integrations/creating-nodes/code/create-bonkxbt-nodes-module/`;
export const EXPRESSIONS_DOCS_URL = `https://${DOCS_DOMAIN}/code-examples/expressions/`;
export const bonkxbt_PRICING_PAGE_URL = 'https://bonkxbt.io/pricing';

export const NODE_INSERT_SPACER_BETWEEN_INPUT_GROUPS = false;
export const NODE_MIN_INPUT_ITEMS_COUNT = 4;

// node types
export const BAMBOO_HR_NODE_TYPE = 'bonkxbt-nodes-base.bambooHr';
export const CALENDLY_TRIGGER_NODE_TYPE = 'bonkxbt-nodes-base.calendlyTrigger';
export const CODE_NODE_TYPE = 'bonkxbt-nodes-base.code';
export const AI_CODE_NODE_TYPE = '@bonkxbt/bonkxbt-nodes-langchain.code';
export const CRON_NODE_TYPE = 'bonkxbt-nodes-base.cron';
export const CLEARBIT_NODE_TYPE = 'bonkxbt-nodes-base.clearbit';
export const FILTER_NODE_TYPE = 'bonkxbt-nodes-base.filter';
export const FUNCTION_NODE_TYPE = 'bonkxbt-nodes-base.function';
export const GITHUB_TRIGGER_NODE_TYPE = 'bonkxbt-nodes-base.githubTrigger';
export const GIT_NODE_TYPE = 'bonkxbt-nodes-base.git';
export const GOOGLE_GMAIL_NODE_TYPE = 'bonkxbt-nodes-base.gmail';
export const GOOGLE_SHEETS_NODE_TYPE = 'bonkxbt-nodes-base.googleSheets';
export const ERROR_TRIGGER_NODE_TYPE = 'bonkxbt-nodes-base.errorTrigger';
export const ELASTIC_SECURITY_NODE_TYPE = 'bonkxbt-nodes-base.elasticSecurity';
export const EMAIL_SEND_NODE_TYPE = 'bonkxbt-nodes-base.emailSend';
export const EMAIL_IMAP_NODE_TYPE = 'bonkxbt-nodes-base.emailReadImap';
export const EXECUTE_COMMAND_NODE_TYPE = 'bonkxbt-nodes-base.executeCommand';
export const FORM_TRIGGER_NODE_TYPE = 'bonkxbt-nodes-base.formTrigger';
export const HTML_NODE_TYPE = 'bonkxbt-nodes-base.html';
export const HTTP_REQUEST_NODE_TYPE = 'bonkxbt-nodes-base.httpRequest';
export const HUBSPOT_TRIGGER_NODE_TYPE = 'bonkxbt-nodes-base.hubspotTrigger';
export const IF_NODE_TYPE = 'bonkxbt-nodes-base.if';
export const INTERVAL_NODE_TYPE = 'bonkxbt-nodes-base.interval';
export const ITEM_LISTS_NODE_TYPE = 'bonkxbt-nodes-base.itemLists';
export const JIRA_NODE_TYPE = 'bonkxbt-nodes-base.jira';
export const JIRA_TRIGGER_NODE_TYPE = 'bonkxbt-nodes-base.jiraTrigger';
export const MICROSOFT_EXCEL_NODE_TYPE = 'bonkxbt-nodes-base.microsoftExcel';
export const MANUAL_TRIGGER_NODE_TYPE = 'bonkxbt-nodes-base.manualTrigger';
export const MANUAL_CHAT_TRIGGER_NODE_TYPE = '@bonkxbt/bonkxbt-nodes-langchain.manualChatTrigger';
export const CHAT_TRIGGER_NODE_TYPE = '@bonkxbt/bonkxbt-nodes-langchain.chatTrigger';
export const AGENT_NODE_TYPE = '@bonkxbt/bonkxbt-nodes-langchain.agent';
export const OPEN_AI_NODE_TYPE = '@bonkxbt/bonkxbt-nodes-langchain.openAi';
export const OPEN_AI_NODE_MESSAGE_ASSISTANT_TYPE =
	'@bonkxbt/bonkxbt-nodes-langchain.openAi.assistant.message';
export const OPEN_AI_ASSISTANT_NODE_TYPE = '@bonkxbt/bonkxbt-nodes-langchain.openAiAssistant';
export const BASIC_CHAIN_NODE_TYPE = '@bonkxbt/bonkxbt-nodes-langchain.chainLlm';
export const QA_CHAIN_NODE_TYPE = '@bonkxbt/bonkxbt-nodes-langchain.chainRetrievalQa';
export const MICROSOFT_TEAMS_NODE_TYPE = 'bonkxbt-nodes-base.microsoftTeams';
export const bonkxbt_NODE_TYPE = 'bonkxbt-nodes-base.bonkxbt';
export const NO_OP_NODE_TYPE = 'bonkxbt-nodes-base.noOp';
export const STICKY_NODE_TYPE = 'bonkxbt-nodes-base.stickyNote';
export const NOTION_TRIGGER_NODE_TYPE = 'bonkxbt-nodes-base.notionTrigger';
export const PAGERDUTY_NODE_TYPE = 'bonkxbt-nodes-base.pagerDuty';
export const SALESFORCE_NODE_TYPE = 'bonkxbt-nodes-base.salesforce';
export const SEGMENT_NODE_TYPE = 'bonkxbt-nodes-base.segment';
export const SET_NODE_TYPE = 'bonkxbt-nodes-base.set';
export const SCHEDULE_TRIGGER_NODE_TYPE = 'bonkxbt-nodes-base.scheduleTrigger';
export const SERVICENOW_NODE_TYPE = 'bonkxbt-nodes-base.serviceNow';
export const SLACK_NODE_TYPE = 'bonkxbt-nodes-base.slack';
export const SPREADSHEET_FILE_NODE_TYPE = 'bonkxbt-nodes-base.spreadsheetFile';
export const SPLIT_IN_BATCHES_NODE_TYPE = 'bonkxbt-nodes-base.splitInBatches';
export const START_NODE_TYPE = 'bonkxbt-nodes-base.start';
export const SWITCH_NODE_TYPE = 'bonkxbt-nodes-base.switch';
export const TELEGRAM_NODE_TYPE = 'bonkxbt-nodes-base.telegram';
export const THE_HIVE_TRIGGER_NODE_TYPE = 'bonkxbt-nodes-base.theHiveTrigger';
export const QUICKBOOKS_NODE_TYPE = 'bonkxbt-nodes-base.quickbooks';
export const WAIT_NODE_TYPE = 'bonkxbt-nodes-base.wait';
export const WEBHOOK_NODE_TYPE = 'bonkxbt-nodes-base.webhook';
export const WORKABLE_TRIGGER_NODE_TYPE = 'bonkxbt-nodes-base.workableTrigger';
export const WORKFLOW_TRIGGER_NODE_TYPE = 'bonkxbt-nodes-base.workflowTrigger';
...
export const WOOCOMMERCE_TRIGGER_NODE_TYPE = 'bonkxbt-nodes-base.wooCommerceTrigger';
export const XERO_NODE_TYPE = 'bonkxbt-nodes-base.xero';
export const ZENDESK_NODE_TYPE = 'bonkxbt-nodes-base.zendesk';
export const ZENDESK_TRIGGER_NODE_TYPE = 'bonkxbt-nodes-base.zendeskTrigger';
export const DISCORD_NODE_TYPE = 'bonkxbt-nodes-base.discord';
export const EXTRACT_FROM_FILE_NODE_TYPE = 'bonkxbt-nodes-base.extractFromFile';
export const CONVERT_TO_FILE_NODE_TYPE = 'bonkxbt-nodes-base.convertToFile';
export const DATETIME_NODE_TYPE = 'bonkxbt-nodes-base.dateTime';
export const REMOVE_DUPLICATES_NODE_TYPE = 'bonkxbt-nodes-base.removeDuplicates';
export const SPLIT_OUT_NODE_TYPE = 'bonkxbt-nodes-base.splitOut';
export const LIMIT_NODE_TYPE = 'bonkxbt-nodes-base.limit';
export const SUMMARIZE_NODE_TYPE = 'bonkxbt-nodes-base.summarize';
export const AGGREGATE_NODE_TYPE = 'bonkxbt-nodes-base.aggregate';
export const MERGE_NODE_TYPE = 'bonkxbt-nodes-base.merge';
export const MARKDOWN_NODE_TYPE = 'bonkxbt-nodes-base.markdown';
export const XML_NODE_TYPE = 'bonkxbt-nodes-base.xml';
export const CRYPTO_NODE_TYPE = 'bonkxbt-nodes-base.crypto';
export const RSS_READ_NODE_TYPE = 'bonkxbt-nodes-base.rssFeedRead';
export const COMPRESSION_NODE_TYPE = 'bonkxbt-nodes-base.compression';
export const EDIT_Ibonkxbt_NODE_TYPE = 'bonkxbt-nodes-base.editIbonkxbt';
export const CHAIN_SUMMARIZATION_LANGCHAIN_NODE_TYPE =
	'@bonkxbt/bonkxbt-nodes-langchain.chainSummarization';
export const SIMULATE_NODE_TYPE = 'bonkxbt-nodes-base.simulate';
export const SIMULATE_TRIGGER_NODE_TYPE = 'bonkxbt-nodes-base.simulateTrigger';
export const AI_TRANSFORM_NODE_TYPE = 'bonkxbt-nodes-base.aiTransform';
export const FORM_NODE_TYPE = 'bonkxbt-nodes-base.form';
export const SLACK_TRIGGER_NODE_TYPE = 'bonkxbt-nodes-base.slackTrigger';
export const TELEGRAM_TRIGGER_NODE_TYPE = 'bonkxbt-nodes-base.telegramTrigger';
export const FACEBOOK_LEAD_ADS_TRIGGER_NODE_TYPE = 'bonkxbt-nodes-base.facebookLeadAdsTrigger';

export const CREDENTIAL_ONLY_NODE_PREFIX = 'bonkxbt-creds-base';
...
export const AI_CODE_TOOL_LANGCHAIN_NODE_TYPE = '@bonkxbt/bonkxbt-nodes-langchain.toolCode';
export const AI_WORKFLOW_TOOL_LANGCHAIN_NODE_TYPE = '@bonkxbt/bonkxbt-nodes-langchain.toolWorkflow';
export const REQUEST_NODE_FORM_URL = 'https://bonkxbt-community.typeform.com/to/K1fBVTZ3';
...
// General
export const INSTANCE_ID_HEADER = 'bonkxbt-instance-id';
...
export const LOCAL_STORAGE_ACTIVATION_FLAG = 'bonkxbt_HIDE_ACTIVATION_ALERT';
export const LOCAL_STORAGE_PIN_DATA_DISCOVERY_NDV_FLAG = 'bonkxbt_PIN_DATA_DISCOVERY_NDV';
export const LOCAL_STORAGE_PIN_DATA_DISCOVERY_CANVAS_FLAG = 'bonkxbt_PIN_DATA_DISCOVERY_CANVAS';
export const LOCAL_STORAGE_MAPPING_IS_ONBOARDED = 'bonkxbt_MAPPING_ONBOARDED';
export const LOCAL_STORAGE_AUTOCOMPLETE_IS_ONBOARDED = 'bonkxbt_AUTOCOMPLETE_ONBOARDED';
export const LOCAL_STORAGE_TABLE_HOVER_IS_ONBOARDED = 'bonkxbt_TABLE_HOVER_ONBOARDED';
export const LOCAL_STORAGE_MAIN_PANEL_RELATIVE_WIDTH = 'bonkxbt_MAIN_PANEL_RELATIVE_WIDTH';
export const LOCAL_STORAGE_ACTIVE_MODAL = 'bonkxbt_ACTIVE_MODAL';
export const LOCAL_STORAGE_THEME = 'bonkxbt_THEME';
export const LOCAL_STORAGE_EXPERIMENT_OVERRIDES = 'bonkxbt_EXPERIMENT_OVERRIDES';
export const LOCAL_STORAGE_HIDE_GITHUB_STAR_BUTTON = 'bonkxbt_HIDE_HIDE_GITHUB_STAR_BUTTON';
export const LOCAL_STORAGE_NDV_INPUT_PANEL_DISPLAY_MODE = 'bonkxbt_NDV_INPUT_PANEL_DISPLAY_MODE';
export const LOCAL_STORAGE_NDV_OUTPUT_PANEL_DISPLAY_MODE = 'bonkxbt_NDV_OUTPUT_PANEL_DISPLAY_MODE';
export const BASE_NODE_SURVEY_URL = 'https://bonkxbt-community.typeform.com/to/BvmzxqYv#nodename=';
...
Love bonkxbt? Help us build the future of automation! https://bonkxbt.io/careers?utm_source=bonkxbt_user&utm_medium=console_output
`;

export const TEMPLATES_NODES_FILTER = ['bonkxbt-nodes-base.start', 'bonkxbt-nodes-base.respondToWebhook'];
...
export const bonkxbt_SALES_EMAIL = 'sales@bonkxbt.io';

export const bonkxbt_CONTACT_EMAIL = 'contact@bonkxbt.io';
...
export const CLOUD_CHANGE_PLAN_PAGE = window.location.host.includes('stage-app.bonkxbt.cloud')
	? 'https://stage-app.bonkxbt.cloud/account/change-plan'
	: 'https://app.bonkxbt.cloud/account/change-plan';

export const CLOUD_BASE_URL_STAGING = 'https://stage-api.bonkxbt.cloud';

export const CLOUD_BASE_URL_PRODUCTION = 'https://api.bonkxbt.cloud';
...
export const CREATOR_HUB_URL = 'https://creators.bonkxbt.io/hub';
...
export const TEMPLATES_URLS = {
	DEFAULT_API_HOST: 'https://api.bonkxbt.io/api/',
	BASE_WEBSITE_URL: 'https://bonkxbt.io/workflows',
	UTM_QUERY: {
		utm_source: 'bonkxbt_app',
...
<h2>Your bonkxbt server is configured to use a secure cookie, <br/>however you are either visiting this via an insecure URL, or using Safari.
</h2>
<br/>
<div style="font-size: 18px; max-width: 640px; text-align: left; margin: 10px auto">
	...
	<ul>
		...
		<li>If you prefer to disable this security feature (<strong>not recommended</strong>), set the environment variable <code>bonkxbt_SECURE_COOKIE</code> to <code>false</code></li>
	</ul>
</div>
</body>`;
...
/** Auth */
export const BROWSER_ID_STORAGE_KEY = 'bonkxbt-browserId';

export const APP_MODALS_ELEMENT_ID = 'app-modals';

export const NEW_SAMPLE_WORKFLOW_CREATED_CHANNEL = 'new-sample-sub-workflow-created';

export const AI_NODES_PACKAGE_NAME = '@bonkxbt/bonkxbt-nodes-langchain';
