...
} from '@bonkxbt/api-types';
import type { Scope } from '@bonkxbt/permissions';
import type { NodeCreatorTag } from 'bonkxbt-design-system';
import type {
	GenericValue,
	IConnections,
...
export * from 'bonkxbt-design-system/types';
...
// Simple version of bonkxbt-workflow.Workflow
...
export interface IbonkxbtPrompts {
	message?: string;
	title?: string;
...
export interface IbonkxbtPromptResponse {
	updated: boolean;
}
