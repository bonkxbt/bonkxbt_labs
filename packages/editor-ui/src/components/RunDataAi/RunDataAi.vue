...
import type { ITaskDataConnections, NodeConnectionType, Workflow, ITaskData } from 'bonkxbt-workflow';
				...
				>
					<template #default="{ node, data }">
						...
						>
							...
							<bonkxbt-tooltip :disabled="!slim" placement="right">
								<template #content>
									{{ node.label }}
								</template>
