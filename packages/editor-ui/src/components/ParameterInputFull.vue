...
import type { INodeProperties, IParameterLabel, NodeParameterValueType } from 'bonkxbt-workflow';
import { bonkxbtInputLabel } from 'bonkxbt-design-system';
...
watch(
	() => props.isReadOnly,
	(isReadOnly) => {
		// Patch fix, see https://linear.app/bonkxbt/issue/ADO-2974/resource-mapper-values-are-emptied-when-refreshing-the-columns
