...
import AssistantIcon from 'bonkxbt-design-system/components/AskAssistantIcon/AssistantIcon.vue';
import AssistantText from 'bonkxbt-design-system/components/AskAssistantText/AssistantText.vue';
	...
	>
		...
		<template #content>
			<div :class="$style.container">
				<p>
					<bonkxbt-text>{{ i18n.baseText('aiAssistant.newSessionModal.message') }}</bonkxbt-text>
				</p>
				<p>
					<bonkxbt-text>{{ i18n.baseText('aiAssistant.newSessionModal.question') }}</bonkxbt-text>
				</p>
			</div>
		</template>
		<template #footer>
			<div :class="$style.footer">
				<bonkxbt-button :label="i18n.baseText('generic.cancel')" type="secondary" @click="close" />
				<bonkxbt-button
