...
import { NodeConnectionType, type IConnectedNode, type IDataObject } from 'bonkxbt-workflow';
...
<template>
	<div class="run-data-schema full-height">
		<div v-if="noSearchResults" class="no-results">
			<bonkxbtText tag="h3" size="large">{{ i18n.baseText('ndv.search.noNodeMatch.title') }}</bonkxbtText>
			<bonkxbtText>
			...
			<bonkxbtText v-if="paneType === 'output'">
