	...
	>
		<template #header>
			<div :class="$style.title">
				<bonkxbt-heading tag="h2" size="medium" color="text-xlight">{{ modalTitle }}</bonkxbt-heading>
			</div>
		</template>
		<template #content>
			<section :class="$style.content">
				<div v-if="showButtons" :class="$style.wrapper">
					...
					<div :class="$style.text">
						<bonkxbt-text size="small" color="text-xlight">{{ NOT_LIKELY_OPTION }}</bonkxbt-text>
						<bonkxbt-text size="small" color="text-xlight">{{ VERY_LIKELY_OPTION }}</bonkxbt-text>
					</div>
				</div>
				<div v-else :class="$style.email">
					...
					<div :class="$style.disclaimer">
						<bonkxbt-text size="small" color="text-dark">
