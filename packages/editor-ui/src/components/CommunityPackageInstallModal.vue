		...
		<template #content>
			<div :class="[$style.descriptionContainer, 'p-s']">
				<div>
					...
					{{ ' ' }}
					<bonkxbt-link :to="COMMUNITY_NODES_INSTALLATION_DOCS_URL" @click="onMoreInfoTopClick">
			...
			<div :class="[$style.formContainer, 'mt-m']">
				...
				>
					<bonkxbt-text>
						{{ i18n.baseText('settings.communityNodes.installModal.checkbox.label') }} </bonkxbt-text
					><br />
					<bonkxbt-link :to="COMMUNITY_NODES_RISKS_DOCS_URL" @click="onLearnMoreLinkClick">{{
						i18n.baseText('generic.moreInfo')
					}}</bonkxbt-link>
				</el-checkbox>
			</div>
