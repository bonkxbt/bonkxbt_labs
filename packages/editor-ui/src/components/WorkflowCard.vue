...
<template>
	<bonkxbt-card :class="$style.cardLink" @click="onClick">
		<template #header>
			<bonkxbt-heading tag="h2" bold :class="$style.cardHeading" data-test-id="workflow-card-name">
				{{ data.name }}
				<bonkxbtBadge v-if="!workflowPermissions.update" class="ml-3xs" theme="tertiary" bold>
