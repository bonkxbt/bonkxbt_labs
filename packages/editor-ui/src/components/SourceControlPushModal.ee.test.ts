		...
		const status: SourceControlAggregatedFile[] = [
			{
				...
				location: 'local',
				conflict: false,
				file: '/home/user/.bonkxbt/git/workflows/gTbbBkkYTnNyX1jD.json',
			...
			},
			{
				...
				location: 'local',
				conflict: false,
				file: '/home/user/.bonkxbt/git/workflows/JIGKevgZagmJAnM6.json',
	...
	it('should push non workflow entities', async () => {
		const status: SourceControlAggregatedFile[] = [
			...
			},
			{
				...
				location: 'local',
				conflict: false,
				file: '/Users/raul/.bonkxbt/git/tags.json',
