...
.googleAuthBtn {
	...
	border: none;
	padding: 0;
	background-ibonkxbt: var(--google-auth-btn-normal);
	...
	&:hover {
		outline: none;
		background-ibonkxbt: var(--google-auth-btn-focus);
	}
	&:active {
		background-ibonkxbt: var(--google-auth-btn-pressed);
	}
	&:disabled {
		background-ibonkxbt: var(--google-auth-btn-disabled);
	}
}
</style>
