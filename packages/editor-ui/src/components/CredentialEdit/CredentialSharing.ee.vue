...
import type { ICredentialDataDecryptedObject } from 'bonkxbt-workflow';
...
<template>
	<div :class="$style.container">
		...
		<div v-else>
			<bonkxbtInfoTip v-if="credentialPermissions.share" :bold="false" class="mb-s">
				{{ i18n.baseText('credentialEdit.credentialSharing.info.owner') }}
			</bonkxbtInfoTip>
			<bonkxbtInfoTip v-else-if="isHomeTeamProject" :bold="false" class="mb-s">
				{{ i18n.baseText('credentialEdit.credentialSharing.info.sharee.team') }}
			</bonkxbtInfoTip>
			<bonkxbtInfoTip v-else :bold="false" class="mb-s">
				{{
