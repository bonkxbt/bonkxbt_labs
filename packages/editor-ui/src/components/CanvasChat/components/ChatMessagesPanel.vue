...
import type { ChatMessage, ChatMessageText } from '@bonkxbt/chat/types';
import { useI18n } from '@/composables/useI18n';
import MessagesList from '@bonkxbt/chat/components/MessagesList.vue';
...
import type { ArrowKeyDownPayload } from '@bonkxbt/chat/components/Input.vue';
import ChatInput from '@bonkxbt/chat/components/Input.vue';
	...
	<div :class="$style.chat" data-test-id="workflow-lm-chat-dialog">
		<header :class="$style.chatHeader">
			...
			<div :class="$style.session">
				...
				<bonkxbt-tooltip placement="left">
					<template #content>
						{{ sessionId }}
					</template>
