...
import { type ResizeData } from 'bonkxbt-design-system';

const LOCAL_STORAGE_PANEL_HEIGHT = 'bonkxbt_CANVAS_CHAT_HEIGHT';
const LOCAL_STORAGE_PANEL_WIDTH = 'bonkxbt_CANVAS_CHAT_WIDTH';
