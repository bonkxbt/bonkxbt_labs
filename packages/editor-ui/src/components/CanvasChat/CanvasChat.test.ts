...
import type { ChatMessage } from '@bonkxbt/chat/types';
...
const mockNodeTypes: INodeTypeDescription[] = [
	{
		...
		name: '@bonkxbt/bonkxbt-nodes-langchain.agent',
		properties: [],
		defaults: {
			name: 'AI Agent',
		},
...
describe('CanvasChat', () => {
	...
	describe('resize functionality', () => {
		...
		it('should persist resize dimensions', () => {
			...
			expect(mockStorage.getItem).toHaveBeenCalledWith('bonkxbt_CANVAS_CHAT_HEIGHT');
			expect(mockStorage.getItem).toHaveBeenCalledWith('bonkxbt_CANVAS_CHAT_WIDTH');
		});
	});
