...
import { bonkxbtIconButton, bonkxbtLink, bonkxbtText, bonkxbtTooltip } from 'bonkxbt-design-system';
...
<template>
	<bonkxbtTooltip placement="bottom-end" :visible="visible">
		<template #content>
			...
			<div v-else>
				...
				<bonkxbtText size="small" tag="p">
					{{ locale.baseText('ndv.pinData.pin.description') }}

					<bonkxbtLink :to="props.dataPinningDocsUrl" size="small">
