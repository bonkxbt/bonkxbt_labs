...
import { randomInt } from 'bonkxbt-workflow';
import type { CodeExecutionMode, INodeExecutionData } from 'bonkxbt-workflow';
	...
	<div>
		...
		<div :class="$style.inputContainer">
			<div :class="$style.meta">
				...
				/>
				<a href="https://docs.bonkxbt.io/code-examples/ai-code" target="_blank" :class="$style.help">
					<bonkxbt-icon icon="question-circle" color="text-light" size="large" />{{
		...
		<div :class="$style.controls">
			<div v-if="isLoading" :class="$style.loader">
				...
				<bonkxbt-circle-loader :radius="8" :progress="loaderProgress" :stroke-width="3" />
			</div>
			<bonkxbtTooltip v-else :disabled="isSubmitEnabled">
				<div>
					<bonkxbtButton
