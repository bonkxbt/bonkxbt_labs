	...
	>
		...
		>
			<div :class="$style.description">
				...
				<bonkxbtText v-else color="text-dark" :bold="true" size="medium" data-test-id="execution-time">
				...
				<div :class="$style.executionStatus">
					...
					/>
					<bonkxbtText :class="$style.statusLabel" size="small">{{ executionUIDetails.label }}</bonkxbtText>
					{{ ' ' }}
					<bonkxbtText
						v-if="executionUIDetails.name === 'running'"
				...
				<div v-if="execution.mode === 'retry'">
					<bonkxbtText :color="isActive ? 'text-dark' : 'text-base'" size="small">
			...
			<div :class="$style.icons">
				...
				/>
				<bonkxbtTooltip v-if="execution.mode === 'manual'" placement="top">
					<template #content>
