...
import type { IWorkflowSettings } from 'bonkxbt-workflow';
	...
	>
		<template #customContent>
			<footer class="mt-2xs">
				...
				<bonkxbtTooltip :disabled="!isNewWorkflow">
					<template #content>
						<div>
							<bonkxbtLink @click.prevent="onSaveWorkflowClick">{{
