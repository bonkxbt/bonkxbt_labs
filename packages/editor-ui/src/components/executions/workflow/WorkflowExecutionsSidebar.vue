...
<template>
	...
	>
		<div :class="$style.heading">
			<bonkxbt-heading tag="h2" size="medium" color="text-dark">
		...
		>
			...
			>
				<bonkxbt-text color="text-base" size="medium" align="center">
			...
			<div v-if="loadingMore" class="mr-m">
				<bonkxbt-loading variant="p" :rows="1" />
			</div>
		</div>
