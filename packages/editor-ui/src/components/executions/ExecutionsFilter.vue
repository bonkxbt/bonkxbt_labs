...
<template>
	<bonkxbt-popover trigger="click" :placement="popoverPlacement" width="440">
		<template #reference>
			<bonkxbt-button
				icon="filter"
				type="tertiary"
			...
			>
				<bonkxbt-badge
					...
					>{{ countSelectedFilterProps }}</bonkxbt-badge
				>
		...
		<div data-test-id="execution-filter-form">
			...
			<div :class="$style.group">
				...
				<div :class="$style.subGroup">
					...
					<bonkxbt-tooltip :disabled="isAdvancedExecutionFilterEnabled" placement="top">
						<template #content>
