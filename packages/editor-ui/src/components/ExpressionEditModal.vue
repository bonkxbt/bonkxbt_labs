...
import { bonkxbtInput, bonkxbtText } from 'bonkxbt-design-system';
import { bonkxbtResizeWrapper, type ResizeData } from 'bonkxbt-design-system';
		...
		<div :class="$style.container">
			...
			>
				<div :class="$style.sidebar">
					...
					>
						<template #prefix>
							<bonkxbtIcon :class="$style.ioSearchIcon" icon="search" />
						</template>
					</bonkxbtInput>
			...
			<div :class="$style.io">
				<div :class="$style.input">
					<div :class="$style.header">
						<bonkxbtText bold size="large">
							{{ i18n.baseText('expressionEdit.expression') }}
						</bonkxbtText>
						<bonkxbtText
							:class="$style.tip"
							size="small"
							v-bonkxbt-html="i18n.baseText('expressionTip.javascript')"
						/>
					</div>
