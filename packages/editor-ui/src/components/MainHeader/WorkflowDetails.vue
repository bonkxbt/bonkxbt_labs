	...
	<div :class="$style.container">
		...
		<PushConnectionTracker class="actions">
			...
			<EnterpriseEdition :features="[EnterpriseEditionFeature.Sharing]">
				...
				<template #fallback>
					<bonkxbtTooltip>
						<bonkxbtButton type="secondary" :class="['mr-2xs', $style.disabledShareButton]">
							{{ i18n.baseText('workflowDetails.share') }}
						</bonkxbtButton>
						<template #content>
							<i18n-t
			...
			<div :class="[$style.workflowMenuContainer, $style.group]">
				...
				/>
				<bonkxbtTooltip :visible="isNodeViewDiscoveryTooltipVisible">
					...
					<template #content>
						<div class="mb-4xs">
							<bonkxbtBadge>{{ i18n.baseText('menuActions.badge.beta') }}</bonkxbtBadge>
						</div>
						<p>{{ i18n.baseText('menuActions.nodeViewDiscovery.tooltip') }}</p>
						<bonkxbtText color="text-light" size="small">
