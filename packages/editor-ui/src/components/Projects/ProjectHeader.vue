...
import { bonkxbtButton } from 'bonkxbt-design-system';
	...
	<div>
		<div :class="[$style.projectHeader]">
			<div :class="[$style.icon]">
				<bonkxbtIcon :icon="headerIcon" color="text-light"></bonkxbtIcon>
			</div>
			<div>
				<bonkxbtHeading bold tag="h2" size="xlarge">{{ projectName }}</bonkxbtHeading>
				<bonkxbtText color="text-light">
					<slot name="subtitle">
