...
<template>
	<Modal width="500px" :name="props.modalName" data-test-id="project-move-resource-modal">
		<template #header>
			<bonkxbtHeading tag="h2" size="xlarge" class="mb-m pr-s">
				{{
		...
		<template #footer>
			<div :class="$style.buttons">
				<bonkxbtButton type="secondary" text class="mr-2xs" @click="closeModal">
					{{ i18n.baseText('generic.cancel') }}
				</bonkxbtButton>
				<bonkxbtButton :disabled="!projectId" type="primary" @click="moveResource">
					{{
