...
<template>
	<bonkxbtTooltip :disabled="!badgeTooltip" placement="top">
		<div class="mr-xs">
			<bonkxbtBadge
				v-if="badgeText"
				:class="$style.badge"
			...
			>
				<bonkxbtIcon v-if="badgeIcon" :icon="badgeIcon" size="small" class="mr-3xs" />
				<span v-bonkxbt-truncate:20>{{ badgeText }}</span>
			</bonkxbtBadge>
			<bonkxbtBadge
