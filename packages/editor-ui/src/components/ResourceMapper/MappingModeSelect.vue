...
import type { INodePropertyTypeOptions, ResourceMapperFields } from 'bonkxbt-workflow';
import { computed, ref, watch } from 'vue';
import { i18n as locale } from '@/plugins/i18n';
import { useNodeSpecificationValues } from '@/composables/useNodeSpecificationValues';
import { bonkxbtInputLabel, bonkxbtSelect, bonkxbtText } from 'bonkxbt-design-system';
				...
				>
					...
					>
						<div class="list-option">
							...
							<div class="option-description" v-bonkxbt-html="option.description" />
						</div>
					</bonkxbtOption>
				</bonkxbtSelect>
			</div>
			<div class="mt-5xs">
				<bonkxbtText v-if="loading" size="small">
					<bonkxbtIcon icon="sync-alt" size="xsmall" :spin="true" />
					{{
				...
				<bonkxbtText v-else-if="errorMessage !== ''" size="small" color="danger">
					<bonkxbtIcon icon="exclamation-triangle" size="xsmall" />
					{{ errorMessage }}
					<bonkxbtLink size="small" theme="danger" :underline="true" @click="onRetryClick">
