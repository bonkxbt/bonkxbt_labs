...
import { NodeHelpers } from 'bonkxbt-workflow';
...
import { bonkxbtButton, bonkxbtCallout } from 'bonkxbt-design-system';
...
<template>
	<div class="mt-4xs" data-test-id="resource-mapper-container">
		...
		/>
		<bonkxbtText v-if="!showMappingModeSelect && state.loading" size="small">
		...
		<MappingFields
			...
			@refresh-field-list="initFetching(true)"
		/>
		<bonkxbtCallout v-else-if="state.hasStaleFields" theme="info" :iconless="true">
