...
import type { IRunData, Workflow } from 'bonkxbt-workflow';
import { jsonParse, NodeHelpers, NodeConnectionType } from 'bonkxbt-workflow';
	...
	>
		...
		>
			...
			<div :class="$style.backToCanvas" data-test-id="back-to-canvas" @click="close">
				<bonkxbt-icon icon="arrow-left" color="text-xlight" size="medium" />
				<bonkxbt-text color="text-xlight" size="medium" :bold="true">
