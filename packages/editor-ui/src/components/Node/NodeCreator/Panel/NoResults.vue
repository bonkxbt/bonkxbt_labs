	...
	>
		...
		<div :class="$style.title">
			...
			>
				...
				<bonkxbt-link v-if="rootView === REGULAR_NODE_CREATOR_VIEW" @click="$emit('addHttpNode')">
					{{ i18n.baseText('nodeCreator.noResults.httpRequest') }}
				</bonkxbt-link>

				<bonkxbt-link v-if="rootView === TRIGGER_NODE_CREATOR_VIEW" @click="$emit('addWebhookNode')">
		...
		<div v-if="showRequest" :class="$style.request">
			...
			<div>
				<bonkxbt-link :to="REQUEST_NODE_FORM_URL">
