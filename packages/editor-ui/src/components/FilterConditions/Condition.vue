	...
	>
		...
		<div :class="$style.status">
			...
			>
				...
				<bonkxbt-icon :class="$style.statusIcon" icon="check-circle" size="medium" color="text-light" />
			</bonkxbt-tooltip>
			...
			>
				...
				<bonkxbt-icon :class="$style.statusIcon" icon="times-circle" size="medium" color="text-light" />
			</bonkxbt-tooltip>
		</div>
	</div>
</template>
