...
import type { GenericValue, IDataObject, INodeExecutionData } from 'bonkxbt-workflow';
...
import { bonkxbtIconButton, bonkxbtInfoTip, bonkxbtTooltip, bonkxbtTree } from 'bonkxbt-design-system';
			...
			<tbody>
				...
				>
					...
					<td
						...
						@mouseleave="onMouseLeaveCell"
					>
						<bonkxbtInfoTip>{{ i18n.baseText('runData.emptyItemHint') }}</bonkxbtInfoTip>
					</td>
			...
			<thead>
				<tr>
					...
					<th v-for="(column, i) in tableData.columns || []" :key="column">
						<bonkxbtTooltip placement="bottom-start" :disabled="!mappingEnabled" :show-after="1000">
							<template #content>
								<div>
					...
					<th v-if="columnLimitExceeded" :class="$style.header">
						<bonkxbtTooltip placement="bottom-end">
							<template #content>
								<div>
			...
			>
				...
				>
					...
					>
						...
						/>
						<bonkxbtTree v-else-if="isObject(data)" :node-class="$style.nodeClass" :value="data">
