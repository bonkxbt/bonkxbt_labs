...
import type { INodeTypeDescription, WorkflowParameters } from 'bonkxbt-workflow';
import { NodeConnectionType, Workflow } from 'bonkxbt-workflow';

const nodeType: INodeTypeDescription = {
	displayName: 'OpenAI',
	name: '@bonkxbt/bonkxbt-nodes-langchain.openAi',
	version: [1],
	inputs: [
...
const node: INodeUi = {
	...
	name: 'OpenAI',
	type: '@bonkxbt/bonkxbt-nodes-langchain.openAi',
	typeVersion: 1.6,
	position: [1300, 540],
};
        ...
        <div>
          <div class="connectedNodesWrapper" style="--nodes-length: 0;">
            <div class="plusButton">
              <bonkxbt-tooltip placement="top" teleported="true" offset="10" show-after="300" disabled="false">
                <bonkxbt-icon-button size="medium" icon="plus" type="tertiary" data-test-id="add-subnode-ai_tool"></bonkxbt-icon-button>
              </bonkxbt-tooltip>
            </div>
            <!--v-if-->
          </div>
