...
describe('useNodeHelpers()', () => {
	...
	describe('isSingleExecution', () => {
		...
		test('should determine based on node parameters if it would be executed once', () => {
			expect(isSingleExecution('bonkxbt-nodes-base.code', {})).toEqual(true);
			expect(isSingleExecution('bonkxbt-nodes-base.code', { mode: 'runOnceForEachItem' })).toEqual(
				false,
			);
			expect(isSingleExecution('bonkxbt-nodes-base.executeWorkflow', {})).toEqual(true);
			expect(isSingleExecution('bonkxbt-nodes-base.executeWorkflow', { mode: 'each' })).toEqual(false);
			expect(isSingleExecution('bonkxbt-nodes-base.crateDb', {})).toEqual(true);
			expect(isSingleExecution('bonkxbt-nodes-base.crateDb', { operation: 'update' })).toEqual(true);
			expect(isSingleExecution('bonkxbt-nodes-base.timescaleDb', {})).toEqual(true);
			expect(isSingleExecution('bonkxbt-nodes-base.timescaleDb', { operation: 'update' })).toEqual(
				true,
			);
			expect(isSingleExecution('bonkxbt-nodes-base.microsoftSql', {})).toEqual(true);
			expect(isSingleExecution('bonkxbt-nodes-base.microsoftSql', { operation: 'update' })).toEqual(
				true,
			);
			expect(isSingleExecution('bonkxbt-nodes-base.microsoftSql', { operation: 'delete' })).toEqual(
				true,
			);
			expect(isSingleExecution('bonkxbt-nodes-base.questDb', {})).toEqual(true);
			expect(isSingleExecution('bonkxbt-nodes-base.mongoDb', { operation: 'insert' })).toEqual(true);
			expect(isSingleExecution('bonkxbt-nodes-base.mongoDb', { operation: 'update' })).toEqual(true);
			expect(isSingleExecution('bonkxbt-nodes-base.redis', {})).toEqual(true);
		});
	});
});
