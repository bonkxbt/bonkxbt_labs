...
import type { PushMessage, PushPayload } from '@bonkxbt/api-types';
import type { ITaskData, WorkflowOperationError, IRunData } from 'bonkxbt-workflow';
					...
					data: {
						...
						rawData: stringify({
							...
							resultData: {
								...
								error: {
									message:
										'Your trial has ended. <a href="https://app.bonkxbt.cloud/account/change-plan">Upgrade now</a> to keep automating',
									name: 'NodeApiError',
									node: 'Last Node',
