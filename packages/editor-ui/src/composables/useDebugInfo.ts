...
import type { WorkflowSettings } from 'bonkxbt-workflow';

type DebugInfo = {
	core: {
		bonkxbtVersion: string;
	...
	security?: {
		...
		blockFileAccessTobonkxbtFiles?: boolean;
	};
	client: {
		userAgent: string;
...
export function useDebugInfo() {
	...
	const securityInfo = () => {
		...
		if (!settingsStore.security.blockFileAccessTobonkxbtFiles) info.blockFileAccessTobonkxbtFiles = false;
