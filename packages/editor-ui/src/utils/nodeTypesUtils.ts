...
const COMMUNITY_PACKAGE_NAME_REGEX = /^(?!@bonkxbt\/)(@\w+\/)?bonkxbt-nodes-(?!base\b)\b\w+/g;
...
export function isCommunityPackageName(packageName: string): boolean {
	...
	// Community packages names start with <@username/>bonkxbt-nodes- not followed by word 'base'
