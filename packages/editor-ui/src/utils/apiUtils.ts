...
import { ApplicationError, jsonParse, type GenericValue, type IDataObject } from 'bonkxbt-workflow';
...
export async function request(config: {
	...
	if (
		...
		!baseURL.includes('api.bonkxbt.io') &&
		!baseURL.includes('bonkxbt.cloud')
	) {
	...
	try {
		...
		if (error.message === 'Network Error') {
			throw new ResponseError("Can't connect to bonkxbt.", {
