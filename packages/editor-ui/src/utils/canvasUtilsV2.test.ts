...
import type { IConnections, INodeTypeDescription, IConnection } from 'bonkxbt-workflow';
...
describe('mapLegacyConnectionsToCanvasConnections', () => {
	...
	// @issue https://linear.app/bonkxbt/issue/bonkxbt-7880/cannot-load-some-templates
