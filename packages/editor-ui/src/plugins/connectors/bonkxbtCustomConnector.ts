...
export type bonkxbtConnectorOptions = ConnectorOptions;
interface bonkxbtConnectorPaintGeometry extends PaintGeometry {
...
export class bonkxbtConnector extends AbstractConnector {
	static type = 'bonkxbtConnector';

	type = bonkxbtConnector.type;
	...
	constructor(
		...
		params: bonkxbtConnectorOptions,
	) {
	...
	writeFlowchartSegments(paintInfo: bonkxbtConnectorPaintGeometry) {
	...
	_getPaintInfo(params: ConnectorComputeParams): bonkxbtConnectorPaintGeometry {
	...
	_computeBezier(paintInfo: bonkxbtConnectorPaintGeometry) {
	...
	_computeFlowchart(paintInfo: bonkxbtConnectorPaintGeometry) {
		this.segments = [];
		this.lastx = null;
		this.lasty = null;
