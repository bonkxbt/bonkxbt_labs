...
import type { DocMetadata, IDataObject, NativeDoc } from 'bonkxbt-workflow';
import { Expression, ExpressionExtensions, NativeMethods, validateFieldType } from 'bonkxbt-workflow';
import {
	...
	return variables.map((variable) =>
		createCompletionOption({
			...
			doc: {
				...
				docURL: 'https://docs.bonkxbt.io/environments/variables/',
			},
		}),
	);
};
	...
	return [
		{
			name: 'statusCode',
			returnType: 'number',
			docURL: 'https://docs.bonkxbt.io/code/builtin/http-node-variables/',
...
export const executionOptions = () => {
	return [
...

		{
			name: 'resumeUrl',
			returnType: 'string',
			docURL: 'https://docs.bonkxbt.io/integrations/builtin/core-nodes/bonkxbt-nodes-base.wait/',
		...
		},
		{
			...
			docURL: 'https://docs.bonkxbt.io/workflows/executions/custom-executions-data/',
	...
	const options: Array<{ doc: DocMetadata; isFunction?: boolean }> = [
		{
			doc: {
				name: 'item',
				returnType: 'Item',
				docURL: 'https://docs.bonkxbt.io/data/data-mapping/data-item-linking/',
	...
	return [
		{
			name: 'json',
			returnType: 'Object',
			docURL: 'https://docs.bonkxbt.io/data/data-structure/',
