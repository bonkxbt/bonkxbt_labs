...
import { bonkxbtPlusEndpoint } from './bonkxbtPlusEndpointType';

export const register = () => {
	registerEndpointRenderer<bonkxbtPlusEndpoint>(bonkxbtPlusEndpoint.type, {
		makeNode: (ep: bonkxbtPlusEndpoint) => {
		...
		updateNode: (ep: bonkxbtPlusEndpoint) => {
