...
import { bonkxbtAddInputEndpoint } from './bonkxbtAddInputEndpointType';

export const register = () => {
	registerEndpointRenderer<bonkxbtAddInputEndpoint>(bonkxbtAddInputEndpoint.type, {
		makeNode: (endpointInstance: bonkxbtAddInputEndpoint) => {
			const xOffset = 1;
			const lineYOffset = -2;
