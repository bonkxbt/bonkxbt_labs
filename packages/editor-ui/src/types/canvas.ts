...
import type { ExecutionStatus, INodeConnections, NodeConnectionType } from 'bonkxbt-workflow';
import type {
	DefaultEdge,
	Node,
	NodeProps,
...
export const enum CanvasNodeRenderType {
	Default = 'default',
	StickyNote = 'bonkxbt-nodes-base.stickyNote',
	AddNodes = 'bonkxbt-nodes-internal.addNodes',
}
