...
export const EASY_AI_WORKFLOW_JSON: WorkflowDataWithTemplateId = {
	name: 'Demo: My first AI Agent in bonkxbt',
	meta: {
	...
	nodes: [
		{
			...
			type: 'bonkxbt-nodes-base.googleCalendarTool',
			typeVersion: 1.2,
			position: [880, 220],
			parameters: {
				operation: 'getAll',
		...
		},
		{
			...
			type: '@bonkxbt/bonkxbt-nodes-langchain.chatTrigger',
			typeVersion: 1.1,
			position: [360, 20],
		...
		},
		{
			...
			name: 'AI Agent',
			type: '@bonkxbt/bonkxbt-nodes-langchain.agent',
			typeVersion: 1.7,
			position: [560, 20],
			parameters: {
				options: {
		...
		},
		{
			...
			name: 'Memory',
			type: '@bonkxbt/bonkxbt-nodes-langchain.memoryBufferWindow',
			typeVersion: 1.3,
			position: [680, 220],
			parameters: {},
		},
		{
			...
			parameters: {
				content:
					'### Want to learn more?\nWant to learn more about AI and how to apply it best in bonkxbt? Have a look at our [new tutorial series on YouTube](https://www.youtube.com/watch?v=yzvLfHb0nqE&lc).',
				height: 100,
				width: 317,
				color: 6,
			},
