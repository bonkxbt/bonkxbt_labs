	...
	>
		...
		<template #empty>
			<div class="text-center mt-s">
				<bonkxbtHeading tag="h2" size="xlarge" class="mb-2xs">
					{{
				...
				<bonkxbtText size="large" color="text-base">
			...
			>
				<bonkxbtCard
					...
					@click="addWorkflow"
				>
					<bonkxbtIcon :class="$style.emptyStateCardIcon" icon="file" />
					<bonkxbtText size="large" class="mt-xs" color="text-dark">
				...
				>
					<bonkxbtIcon :class="$style.emptyStateCardIcon" icon="robot" />
					<bonkxbtText size="large" class="mt-xs pl-2xs pr-2xs" color="text-dark">
