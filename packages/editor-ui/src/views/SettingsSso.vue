...
<template>
	<div class="pb-3xl">
		<bonkxbt-heading size="2xlarge">{{ i18n.baseText('settings.sso.title') }}</bonkxbt-heading>
		<div :class="$style.top">
			<bonkxbt-heading size="xlarge">{{ i18n.baseText('settings.sso.subtitle') }}</bonkxbt-heading>
			<bonkxbt-tooltip
		...
		<bonkxbt-info-tip>
			...
			<a href="https://docs.bonkxbt.io/user-management/saml/" target="_blank">
		...
		<div v-if="ssoStore.isEnterpriseSamlEnabled" data-test-id="sso-content-licensed">
			...
			<div :class="$style.group">
				...
				<div class="mt-2xs mb-s">
					<bonkxbt-radio-buttons v-model="ipsType" :options="ipsOptions" />
				</div>
			...
			<div :class="$style.buttons">
				<bonkxbt-button :disabled="!isSaveEnabled" size="large" data-test-id="sso-save" @click="onSave">
