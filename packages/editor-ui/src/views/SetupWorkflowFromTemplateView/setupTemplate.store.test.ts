...
const testTemplate1 = mock<ITemplatesWorkflowFull>({
	...
	workflow: {
		nodes: [
			mockTemplateNode('IMAP Email', 'bonkxbt-nodes-base.emailReadImap'),
			mockTemplateNode('Nextcloud', 'bonkxbt-nodes-base.nextCloud'),
		],
	},
	full: true,
});
...
const testTemplate2 = mock<ITemplatesWorkflowFull>({
	...
	workflow: {
		nodes: [
			{
				...mockTemplateNode('Telegram', 'bonkxbt-nodes-base.telegram'),
				credentials: {
			...
			expect(setupTemplateStore.credentialUsages).toEqual([
				{
					...
					credentialType: 'imap',
					key: 'imap-',
					nodeTypeName: 'bonkxbt-nodes-base.emailReadImap',
				...
				},
				{
					...
					key: 'nextCloudApi-',
					nodeTypeName: 'bonkxbt-nodes-base.nextCloud',
