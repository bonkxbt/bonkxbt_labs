...
<template>
	<div :class="$style.view">
		<bonkxbt-heading :class="$style.header" tag="h2" size="medium">
			{{ activeWorkflow?.name }}
		</bonkxbt-heading>
		<div :class="$style.corner">
			<bonkxbt-heading tag="h2" size="medium" bold>
				{{ i18n.baseText('workflowHistory.title') }}
			</bonkxbt-heading>
			<router-link :to="editorRoute" data-test-id="workflow-history-close-button">
				<bonkxbt-button type="tertiary" icon="times" size="small" text square />
			</router-link>
		</div>
