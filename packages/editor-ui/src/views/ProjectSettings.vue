...
const nameInput = ref<InstanceType<typeof bonkxbtFormInput> | null>(null);
			...
			<fieldset :class="$style.buttons">
				<div>
					...
					<bonkxbtButton
						...
						>{{ i18n.baseText('projects.settings.button.cancel') }}</bonkxbtButton
					>
				</div>
				<bonkxbtButton
					...
					>{{ i18n.baseText('projects.settings.button.save') }}</bonkxbtButton
				>
			</fieldset>
			<fieldset>
				<hr class="mb-2xl" />
				...
				<bonkxbtButton
					...
					>{{ i18n.baseText('projects.settings.danger.deleteProject') }}</bonkxbtButton
				>
			</fieldset>
		</form>
		<ProjectDeleteDialog
