...
<template>
	<div :class="$style.container">
		<div>
			<bonkxbt-heading size="2xlarge">{{ i18n.baseText('settings.users') }}</bonkxbt-heading>
			<div v-if="!showUMSetupWarning" :class="$style.buttonContainer">
				<bonkxbt-tooltip :disabled="!ssoStore.isSamlLoginEnabled">
					<template #content>
		...
		<bonkxbt-notice v-if="!isAdvancedPermissionsEnabled">
			<i18n-t keypath="settings.users.advancedPermissions.warning">
				<template #link>
					<bonkxbt-link size="small" @click="goToUpgradeAdvancedPermissions">
