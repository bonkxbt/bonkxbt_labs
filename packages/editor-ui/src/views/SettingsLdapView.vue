...
<template>
	<div v-if="!isLDAPFeatureEnabled">
		...
		<bonkxbt-info-tip type="note" theme="info" tooltip-placement="right" class="mb-l">
	...
	<div v-else>
		<div :class="$style.container">
			...
			<div :class="$style.docsInfoTip">
				<bonkxbt-info-tip theme="info" type="note">
					<span v-bonkxbt-html="i18n.baseText('settings.ldap.infoTip')"></span>
				</bonkxbt-info-tip>
			</div>
		...
		<div v-if="loginEnabled">
			<bonkxbt-heading tag="h1" class="mb-xl mt-3xl" size="medium">{{
