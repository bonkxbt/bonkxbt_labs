...
<template>
	<div>
		...
		<template v-if="isLicensed">
			<div class="mb-l">
				<bonkxbt-info-tip theme="info" type="note">
					<span v-bonkxbt-html="i18n.baseText('settings.log-streaming.infoText')"></span>
				</bonkxbt-info-tip>
			</div>
			<template v-if="storeHasItems()">
				...
				<div class="mt-m text-right">
					<bonkxbt-button v-if="canManageLogStreaming" size="large" @click="addDestination">
			...
			<div v-else data-test-id="action-box-licensed">
				...
				>
					<template #heading>
						<span v-bonkxbt-html="i18n.baseText(`settings.log-streaming.addFirstTitle`)" />
					</template>
				</bonkxbt-action-box>
			</div>
		</template>
		<template v-else>
			...
			<div data-test-id="action-box-unlicensed">
				...
				>
					<template #heading>
						<span v-bonkxbt-html="i18n.baseText('settings.log-streaming.actionBox.title')" />
					</template>
				</bonkxbt-action-box>
			</div>
		</template>
