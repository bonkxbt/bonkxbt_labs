...
import type { IUserSettings, NpsSurveyState } from 'bonkxbt-workflow';
import { useSettingsStore } from './settings.store';
import { updateNpsSurveyState } from '@/api/npsSurvey';
import type { IbonkxbtPrompts } from '@/Interface';
...
export const useNpsSurveyStore = defineStore('npsSurvey', () => {
	...
	const promptsData = ref<IbonkxbtPrompts | undefined>();
