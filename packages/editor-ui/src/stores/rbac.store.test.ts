...
import { hasScope } from '@bonkxbt/permissions';

vi.mock('@bonkxbt/permissions', async () => {
	// eslint-disable-next-line @typescript-eslint/consistent-type-imports
	const { hasScope } = await vi.importActual<typeof import('@bonkxbt/permissions')>('@bonkxbt/permissions');
	return {
