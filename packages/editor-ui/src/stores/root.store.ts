...
import { randomString, setGlobalState } from 'bonkxbt-workflow';
...
export const useRootStore = defineStore(STORES.ROOT, () => {
	...
	const restCloudApiContext = computed(() => ({
		baseUrl: window.location.host.includes('stage-app.bonkxbt.cloud')
	...
	const setbonkxbtMetadata = (metadata: RootState['bonkxbtMetadata']) => {
		state.value.bonkxbtMetadata = metadata;
	};
