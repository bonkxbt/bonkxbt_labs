...
import type { IDataObject, INodeInputConfiguration, NodeParameterValueType } from 'bonkxbt-workflow';
import { NodeConnectionType, nodeConnectionTypes, NodeHelpers } from 'bonkxbt-workflow';
