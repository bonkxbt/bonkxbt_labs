...
import type { IUserManagementSettings, FrontendSettings } from '@bonkxbt/api-types';
...
import type { IDataObject, WorkflowSettings } from 'bonkxbt-workflow';
import { ExpressionEvaluatorProxy } from 'bonkxbt-workflow';
...
export const useSettingsStore = defineStore(STORES.SETTINGS, () => {
	...
	const security = computed(() => ({
		blockFileAccessTobonkxbtFiles: settings.value.security.blockFileAccessTobonkxbtFiles,
	...
	const getSettings = async () => {
		...
		rootStore.setbonkxbtMetadata(fetchedSettings.bonkxbtMetadata || {});
