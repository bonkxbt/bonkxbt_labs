import type { bonkxbtLocale, bonkxbtLocaleTranslateFn } from 'bonkxbt-design-system/types';
...
let i18nHandler: bonkxbtLocaleTranslateFn;
...
export async function use(l: string) {
	try {
		const ndsLang = (await import(`./lang/${l}.ts`)) as { default: bonkxbtLocale };
...
export function i18n(fn: bonkxbtLocaleTranslateFn) {
