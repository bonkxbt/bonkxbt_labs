...
/**
 * Custom directive `bonkxbtHtml` to replace v-html from Vue to sanitize content.
 *
 * Usage:
 * In your Vue template, use the directive `v-bonkxbt-html` passing the unsafe HTML.
 *
 * Example:
 * <p v-bonkxbt-html="'<a href="https://site.com" onclick="alert(1)">link</a>'">
 *
...
export const bonkxbtHtml: ObjectDirective = {
