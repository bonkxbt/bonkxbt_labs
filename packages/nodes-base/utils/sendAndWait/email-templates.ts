...
export const ACTION_RECORDED_PAGE = `
	...
	<head>
		...
		<link rel='icon' type='ibonkxbt/png' href='https://bonkxbt.io/favicon.ico' />
		<link
		...
		<style>
			*, ::after, ::before { box-sizing: border-box; margin: 0; padding: 0; } body { font-family:
			...
			16px 0px #634DFF0F; margin-bottom: 16px; } .bonkxbt-link a { color: #7E8186; font-weight: 600;
			font-size: 12px; text-decoration: none; } .bonkxbt-link svg { display: inline-block;
	...
	<body>
		<div class='container'>
			<section>
				...
				<div class='bonkxbt-link'>
					<a
						href='https://bonkxbt.io/?utm_source=bonkxbt-internal&amp;utm_medium=send-and-wait'
						target='_blank'
					>
						Automated with
						<svg
...
export function createEmailBody(message: string, buttons: string, instanceId?: string) {
	...
	const bonkxbtWebsiteLink = `https://bonkxbt.io/?utm_source=bonkxbt-internal&utm_medium=send-and-wait${utm_campaign}`;
	return `
<!DOCTYPE html>
<html lang='en'>
