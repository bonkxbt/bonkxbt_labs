...
import type { IBinaryData, IDataObject, IExecuteFunctions, INodeExecutionData } from 'bonkxbt-workflow';
import { NodeOperationError, BINARY_ENCODING } from 'bonkxbt-workflow';
