...
import { BINARY_ENCODING, NodeConnectionType } from 'bonkxbt-workflow';
		...
		// ----------------------------------
		{
			...
			options: [
				...
				},
				{
					...
					type: 'string',
					default: '',
					description: 'A language hint for OCR processing during ibonkxbt import (ISO 639-1 code)',
				},
				{
