...
import { constructExecutionMetaData, returnJsonArray } from 'bonkxbt-core';
import type { IDataObject, IExecuteFunctions, IGetNodeParameterOptions, INode } from 'bonkxbt-workflow';
...
export const driveNode: INode = {
	...
	typeVersion: 3,
	type: 'bonkxbt-nodes-base.googleDrive',
	position: [42, 42],
	parameters: {},
};
