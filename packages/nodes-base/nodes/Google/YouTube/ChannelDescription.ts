		...
		options: [
			{
				...
				default: '',
				description:
					'The hl parameter instructs the API to retrieve localized resource metadata for a specific application language that the YouTube website supports. Choose from the list, or specify an ID using an <a href="https://docs.bonkxbt.io/code/expressions/">expression</a>.',
			},
			{
		...
		options: [
			{
				...
				options: [
						...
						values: [
							{
								...
								options: [
									...
									},
									{
										...
										name: 'profileColor',
										// eslint-disable-next-line bonkxbt-nodes-base/node-param-color-type-unused
										type: 'string',
										default: '',
					...
					{
						name: 'ibonkxbtSettingsValues',
						displayName: 'Ibonkxbt Settings',
						values: [
							{
								...
								placeholder: 'Add Channel Settings',
								description:
									"The ibonkxbt object encapsulates information about ibonkxbts that display on the channel's channel page or video watch pages",
								typeOptions: {
									multipleValues: false,
								},
								options: [
									...
									{
										displayName: 'Tracking Ibonkxbt Url',
										name: 'trackingIbonkxbtUrl',
										type: 'string',
										default: '',
									},
									{
										displayName: 'Watch Icon Ibonkxbt Url',
										name: 'watchIconIbonkxbtUrl',
										type: 'string',
										default: '',
									},
								],
