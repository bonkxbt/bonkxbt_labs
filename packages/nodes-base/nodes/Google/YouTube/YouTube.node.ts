...
import { NodeConnectionType, BINARY_ENCODING, NodeOperationError } from 'bonkxbt-workflow';
				...
				if (resource === 'channel') {
					...
					if (operation === 'update') {
						...
						if (updateFields.brandingSettingsUi) {
							...
							const ibonkxbtSettingsValues = (updateFields.brandingSettingsUi as IDataObject)
								.ibonkxbtSettingsValues as IDataObject | undefined;
							const ibonkxbtSettings: IDataObject = {};
							if (ibonkxbtSettingsValues?.ibonkxbt) {
								const ibonkxbtSettingsOptions = ibonkxbtSettings.ibonkxbt as IDataObject;
								if (ibonkxbtSettingsOptions.bannerExternalUrl) {
									ibonkxbtSettings.bannerExternalUrl =
										ibonkxbtSettingsOptions.bannerExternalUrl as string;
								}
								if (ibonkxbtSettingsOptions.trackingIbonkxbtUrl) {
									ibonkxbtSettings.trackingIbonkxbtUrl = ibonkxbtSettingsOptions.trackingIbonkxbtUrl as string;
								}
								if (ibonkxbtSettingsOptions.watchIconIbonkxbtUrl) {
									ibonkxbtSettings.watchIconIbonkxbtUrl =
										ibonkxbtSettingsOptions.watchIconIbonkxbtUrl as string;
								}
							}
							...
							//@ts-ignore
							body.brandingSettings.ibonkxbt = ibonkxbtSettings;
						}
