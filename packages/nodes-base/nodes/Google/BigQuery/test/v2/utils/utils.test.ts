...
import { constructExecutionMetaData } from 'bonkxbt-core';
import type { IDataObject, IExecuteFunctions, INode } from 'bonkxbt-workflow';
							...
							v: [
								{
									v: {
										f: [
											...
											{
												v: 'bonkxbt-nodes-base.zendeskTrigger',
											},
											{
												v: {
													f: [
					...
					nodes: [
						{
							...
							type: 'bonkxbt-nodes-base.zendeskTrigger',
							parameters: [
								{
									conditions: [
										{
