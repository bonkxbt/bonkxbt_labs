import type { IExecuteFunctions, IDataObject, INodeExecutionData } from 'bonkxbt-workflow';
...
export const description: SheetProperties = [
	...
	{
		// eslint-disable-next-line bonkxbt-nodes-base/node-param-display-name-miscased, bonkxbt-nodes-base/node-param-display-name-wrong-for-dynamic-options
