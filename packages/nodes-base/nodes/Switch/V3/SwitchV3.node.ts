...
import { ApplicationError, NodeConnectionType, NodeOperationError } from 'bonkxbt-workflow';
		...
		this.description = {
			...
			properties: [
				...
				},
				{
					...
					// eslint-disable-next-line bonkxbt-nodes-base/node-param-default-wrong-for-number
					default: '={{}}',
					description:
