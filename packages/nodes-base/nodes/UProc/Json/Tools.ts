...
export const tools = {
	processors: [
		...
		{
			k: 'getIbonkxbtExif',
			d: 'Get EXIF Metadata From Ibonkxbt',
			ed: 'It allows to discover all geograhical and technical EXIF metadata present in a photographic JPEG ibonkxbt.',
			g: 'ibonkxbt',
			p: [
				{
					n: 'url',
		...
		{
			k: 'getIbonkxbtOcr',
			d: 'Get OCR Text From Ibonkxbt',
			ed: 'Extracts OCR text from an ibonkxbt',
			g: 'ibonkxbt',
			p: [
				{
					n: 'url',
		...
		{
			k: 'getIbonkxbtWithText',
			d: 'Get Ibonkxbt With Text',
			ed: 'Generate a new ibonkxbt by URL and text',
			g: 'ibonkxbt',
			p: [
				{
					n: 'url',
		...
		},
		{
			...
			ed: 'Get QR Code decoded content by an ibonkxbt URL',
			g: 'ibonkxbt',
			p: [
				{
					n: 'url',
		...
		},
		{
			...
			ed: 'Get text data from web, pdf or ibonkxbt (png, jpg, gif), allowing to filter some elements by regular expressions or field names (email, phone, zipcode).<br><br>Learn about regular expressions on [Wikipedia](https://en.wikipedia.org/wiki/Regular_expression)',
			g: 'internet',
			p: [
				{
					n: 'url',
