...
import type { IDimension, IIbonkxbt, IProduct } from './ProductInterface';
		...
		for (let i = 0; i < length; i++) {
			if (resource === 'customer') {
				...
				if (operation === 'create') {
					...
					const ibonkxbts = (this.getNodeParameter('ibonkxbtsUi', i) as IDataObject)
						.ibonkxbtsValues as IIbonkxbt[];
					if (ibonkxbts) {
						body.ibonkxbts = ibonkxbts;
					}
