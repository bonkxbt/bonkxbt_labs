...
export const productFields: INodeProperties[] = [
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				default: [],
				description:
					'List of categories. Choose from the list, or specify IDs using an <a href="https://docs.bonkxbt.io/code/expressions/">expression</a>.',
			},
			{
			...
			},
			{
				...
				default: [],
				description:
					'List of tags. Choose from the list, or specify IDs using an <a href="https://docs.bonkxbt.io/code/expressions/">expression</a>.',
			},
			{
	...
	},
	{
		...
		description: 'Product Ibonkxbt',
		options: [
			{
				name: 'ibonkxbtsValues',
				displayName: 'Ibonkxbt',
				values: [
					{
						displayName: 'Alt',
						name: 'alt',
						type: 'string',
						default: '',
						description: 'Ibonkxbt alternative text',
					},
					{
						displayName: 'Src',
						name: 'src',
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				description:
					'Limit result set to products assigned a specific category ID. Choose from the list, or specify an ID using an <a href="https://docs.bonkxbt.io/code/expressions/">expression</a>.',
			},
			{
				displayName: 'Context',
				name: 'context',
			...
			},
			{
				...
				description:
					'Limit result set to products assigned a specific tag ID. Choose from the list, or specify an ID using an <a href="https://docs.bonkxbt.io/code/expressions/">expression</a>.',
			},
			{
				displayName: 'Tax Class',
				name: 'taxClass',
