import * as bonkxbtWorkflow from 'bonkxbt-workflow';
...
describe('ScheduleTrigger', () => {
	Object.defineProperty(bonkxbtWorkflow, 'randomInt', {
	...
	describe('trigger', () => {
		...
		it('should throw on invalid cron expressions', async () => {
			...
			).rejects.toBeInstanceOf(bonkxbtWorkflow.NodeOperationError);
		});
