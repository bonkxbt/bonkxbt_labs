		...
		options: [
			{
				...
				type: 'string',
				default: '',
				description: 'An avatar ibonkxbt URL. note: the ibonkxbt URL needs to be https.',
			},
			{
				...
				default: [],
				description:
					'Identifies the companies this user belongs to. Choose from the list, or specify IDs using an <a href="https://docs.bonkxbt.io/code/expressions/">expression</a>.',
			},
			{
				displayName: 'Email',
				name: 'email',
