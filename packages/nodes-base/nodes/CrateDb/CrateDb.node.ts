				...
				options: [
					{
						...
						default: 'multiple',
						description:
							'The way queries should be sent to database. Can be used in conjunction with <b>Continue on Fail</b>. See <a href="https://docs.bonkxbt.io/integrations/builtin/app-nodes/bonkxbt-nodes-base.cratedb/">the docs</a> for more examples.',
					},
					{
