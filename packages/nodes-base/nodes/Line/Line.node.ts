			...
			try {
				if (resource === 'notification') {
					...
					if (operation === 'send') {
						...
						if (body.ibonkxbtUi) {
							const ibonkxbt = (body.ibonkxbtUi as IDataObject).ibonkxbtValue as IDataObject;

							if (ibonkxbt && ibonkxbt.binaryData === true) {
								const binaryProperty = ibonkxbt.binaryProperty as string;
								...
								body.ibonkxbtFullsize = ibonkxbt.ibonkxbtFullsize;
								body.ibonkxbtThumbnail = ibonkxbt.ibonkxbtThumbnail;
							}
							delete body.ibonkxbtUi;
						}
