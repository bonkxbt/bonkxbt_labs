import type { INodeProperties, IExecuteFunctions, IDataObject } from 'bonkxbt-workflow';
...
const properties: INodeProperties[] = [
	...
	},
	{
		...
		type: 'multiOptions',
		description:
			'Comma-separated list of roles to assign to the user. Choose from the list, or specify IDs using an <a href="https://docs.bonkxbt.io/code/expressions/">expression</a>.',
		required: true,
		default: ['user'],
		typeOptions: {
