...
export const description: INodeProperties[] = [
	{
		...
		options: [
			...
			{
				// eslint-disable-next-line bonkxbt-nodes-base/node-param-option-name-wrong-for-upsert
				name: 'Append or Update',
				value: 'upsert',
				// eslint-disable-next-line bonkxbt-nodes-base/node-param-description-wrong-for-upsert
