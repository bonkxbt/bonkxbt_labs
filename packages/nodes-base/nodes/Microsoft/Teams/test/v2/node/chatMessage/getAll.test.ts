		...
		return [
			...
			},
			{
				...
				body: {
					contentType: 'html',
					content:
						'tada<br>\n<br>\n<em> Powered by <a href="http://localhost:5678/workflow/5sTm8tp3j3niFewr?utm_source=bonkxbt-internal&amp;utm_medium=powered_by&amp;utm_campaign=bonkxbt-nodes-base.microsoftTeams_b888bd11cd1ddbb95450babf3e199556799d999b896f650de768b8370ee50363">this bonkxbt workflow</a> </em>',
				},
				attachments: [],
				mentions: [],
				reactions: [],
