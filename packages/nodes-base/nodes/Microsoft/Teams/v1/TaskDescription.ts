...
export const taskFields: INodeProperties[] = [
	...
	},
	{
		...
		default: '',
		description:
			'The plan for the task to belong to. Choose from the list, or specify an ID using an <a href="https://docs.bonkxbt.io/code/expressions/">expression</a>.',
	},
	{
		...
		default: '',
		description:
			'The bucket for the task to belong to. Choose from the list, or specify an ID using an <a href="https://docs.bonkxbt.io/code/expressions/">expression</a>.',
	},
	{
		displayName: 'Title',
		name: 'title',
		...
		options: [
			{
				...
				default: '',
				description:
					'Who the task should be assigned to. Choose from the list, or specify an ID using an <a href="https://docs.bonkxbt.io/code/expressions/">expression</a>.',
			},
			{
			...
			},
			{
				...
				default: [],
				description:
					'Labels to assign to the task. Choose from the list, or specify IDs using an <a href="https://docs.bonkxbt.io/code/expressions/">expression</a>.',
			},
			{
