import type { IDataObject, INodeProperties } from 'bonkxbt-workflow';
		...
		options: [
			{
				...
				type: 'multiOptions',
				description:
					'The group to assign this collection to. Choose from the list, or specify IDs using an <a href="https://docs.bonkxbt.io/code/expressions/">expression</a>.',
				default: [],
				typeOptions: {
