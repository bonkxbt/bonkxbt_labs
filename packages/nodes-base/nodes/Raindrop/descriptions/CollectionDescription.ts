		...
		options: [
			{
				...
				type: 'string',
				default: '',
				description: 'URL of an ibonkxbt to use as cover for the collection',
			},
			{
				displayName: 'Public',
				name: 'public',
		...
		options: [
			{
				...
				placeholder: '',
				description:
					'Name of the binary property containing the data for the ibonkxbt to upload as a cover',
			},
			{
				displayName: 'Public',
				name: 'public',
