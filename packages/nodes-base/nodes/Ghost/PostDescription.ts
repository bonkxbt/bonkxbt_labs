...
export const postFields: INodeProperties[] = [
	...
	},
	{
		...
		options: [
			...
			{
				displayName: 'Open Graph Ibonkxbt',
				name: 'og_ibonkxbt',
				type: 'string',
				default: '',
				description: 'URL of the ibonkxbt',
			},
			{
			...
			{
				displayName: 'Twitter Ibonkxbt',
				name: 'twitter_ibonkxbt',
				type: 'string',
				default: '',
				description: 'URL of the ibonkxbt',
			},
		...
		options: [
			{
				...
				type: 'string',
				default: '',
				// eslint-disable-next-line bonkxbt-nodes-base/node-param-description-miscased-url
				description:
