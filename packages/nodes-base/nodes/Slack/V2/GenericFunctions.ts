...
export function getMessageContent(
	...
	const automatedMessage = `_Automated with this <${this.getInstanceBaseUrl()}workflow/${id}?utm_source=bonkxbt-internal&utm_medium=powered_by&utm_campaign=${encodeURIComponent(
		'bonkxbt-nodes-base.slack',
	)}${instanceId ? '_' + instanceId : ''}|bonkxbt workflow>_`;
