import { SEND_AND_WAIT_OPERATION, type INodeProperties } from 'bonkxbt-workflow';
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				description:
					'Set an ibonkxbt or an emoji as the Profile Photo (avatar) of the bot sending the message. Will not be used if sending message as a user.',
				options: [
					{
						name: 'ibonkxbtValues',
