import type { IDisplayOptions, INodeProperties } from 'bonkxbt-workflow';
...
const typeMention: INodeProperties[] = [
	...
	},
	{
		...
		default: '',
		description:
			'The ID of the user being mentioned. Choose from the list, or specify an ID using an <a href="https://docs.bonkxbt.io/code/expressions/">expression</a>.',
	},
	{
		displayName: 'Page ID',
		name: 'page',
...
const ibonkxbtBlock = (type: string): INodeProperties[] => [
	{
		...
		default: '',
		description: 'Ibonkxbt file reference',
	},
];
...
const block = (blockType: string): INodeProperties[] => {
	...
	switch (blockType) {
		...
		case 'child_page':
			...
			break;
		case 'ibonkxbt':
			data.push(...ibonkxbtBlock(blockType));
			break;
		default:
			data.push(
				...richText({
