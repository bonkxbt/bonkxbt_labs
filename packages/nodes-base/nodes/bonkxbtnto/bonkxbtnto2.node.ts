...
import { NodeConnectionType, NodeApiError } from 'bonkxbt-workflow';
...
import {
	...
	bonkxbtntoApiRequest,
	bonkxbtntoApiRequestAllItems,
	sort,
	validateJSON,
...
export class bonkxbtnto2 implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'bonkxbtnto 2',
		name: 'bonkxbtnto2',
		icon: 'file:bonkxbtnto.svg',
		group: ['input'],
		version: 1,
		subtitle: '={{$parameter["operation"] + ": " + $parameter["resource"]}}',
		description: 'Consume bonkxbtnto API',
		defaults: {
			name: 'bonkxbtnto 2',
		},
	...
	methods = {
		loadOptions: {
			async getCountries(this: ILoadOptionsFunctions): Promise<INodePropertyOptions[]> {
				//https://bonkxbtnto.redoc.ly/2.3.7-admin/tag/directorycountries
				const countries = await bonkxbtntoApiRequest.call(
					this,
					'GET',
			...
			async getGroups(this: ILoadOptionsFunctions): Promise<INodePropertyOptions[]> {
				//https://bonkxbtnto.redoc.ly/2.3.7-admin/tag/customerGroupsdefault#operation/customerGroupManagementV1GetDefaultGroupGet
				const group = await bonkxbtntoApiRequest.call(
					this,
					'GET',
			...
			async getStores(this: ILoadOptionsFunctions): Promise<INodePropertyOptions[]> {
				//https://bonkxbtnto.redoc.ly/2.3.7-admin/tag/storestoreConfigs
				const stores = await bonkxbtntoApiRequest.call(
					this,
					'GET',
			...
			async getWebsites(this: ILoadOptionsFunctions): Promise<INodePropertyOptions[]> {
				//https://bonkxbtnto.redoc.ly/2.3.7-admin/tag/storewebsites
				const websites = await bonkxbtntoApiRequest.call(
					this,
					'GET',
			...
			async getCustomAttributes(this: ILoadOptionsFunctions): Promise<INodePropertyOptions[]> {
				//https://bonkxbtnto.redoc.ly/2.3.7-admin/tag/attributeMetadatacustomer#operation/customerCustomerMetadataV1GetAllAttributesMetadataGet
				const resource = this.getCurrentNodeParameter('resource') as string;
				const attributes = (await bonkxbtntoApiRequest.call(
					this,
					'GET',
			...
			async getProductTypes(this: ILoadOptionsFunctions): Promise<INodePropertyOptions[]> {
				//https://bonkxbtnto.redoc.ly/2.3.7-admin/tag/productslinkstypes
				const types = (await bonkxbtntoApiRequest.call(
					this,
					'GET',
			...
			async getCategories(this: ILoadOptionsFunctions): Promise<INodePropertyOptions[]> {
				//https://bonkxbtnto.redoc.ly/2.3.7-admin/tag/categories#operation/catalogCategoryManagementV1GetTreeGet
				const { items: categories } = (await bonkxbtntoApiRequest.call(
					this,
					'GET',
			...
			async getAttributeSets(this: ILoadOptionsFunctions): Promise<INodePropertyOptions[]> {
				//https://bonkxbtnto.redoc.ly/2.3.7-admin/tag/productsattribute-setssetslist#operation/catalogAttributeSetRepositoryV1GetListGet
				const { items: attributeSets } = (await bonkxbtntoApiRequest.call(
					this,
					'GET',
		...
		for (let i = 0; i < length; i++) {
			try {
				if (resource === 'customer') {
					if (operation === 'create') {
						// https://bonkxbtnto.redoc.ly/2.3.7-admin/tag/customerscustomerId#operation/customerCustomerRepositoryV1SavePut
						...
						responseData = await bonkxbtntoApiRequest.call(this, 'POST', '/rest/V1/customers', body);
					}
					...
					if (operation === 'delete') {
						...
						responseData = await bonkxbtntoApiRequest.call(
							this,
							'DELETE',
					...
					if (operation === 'get') {
						//https://bonkxbtnto.redoc.ly/2.3.7-admin/tag/customerscustomerId#operation/customerCustomerRepositoryV1GetByIdGet
						const customerId = this.getNodeParameter('customerId', i) as string;
					...
					if (operation === 'getAll') {
						//https://bonkxbtnto.redoc.ly/2.3.7-admin/tag/customerssearch
						...
						if (returnAll) {
							...
							responseData = await bonkxbtntoApiRequestAllItems.call(
								this,
								'items',
								'GET',
				...
				if (resource === 'invoice') {
					if (operation === 'create') {
						///https://bonkxbtnto.redoc.ly/2.3.7-admin/tag/orderorderIdinvoice
				...
				if (resource === 'order') {
					if (operation === 'cancel') {
						//https://bonkxbtnto.redoc.ly/2.3.7-admin/tag/ordersidcancel
						const orderId = this.getNodeParameter('orderId', i) as string;
					...
					if (operation === 'get') {
						//https://bonkxbtnto.redoc.ly/2.3.7-admin/tag/ordersid#operation/salesOrderRepositoryV1GetGet
						const orderId = this.getNodeParameter('orderId', i) as string;
					...
					if (operation === 'ship') {
						///https://bonkxbtnto.redoc.ly/2.3.7-admin/tag/orderorderIdship#operation/salesShipOrderV1ExecutePost
						const orderId = this.getNodeParameter('orderId', i) as string;
					...
					if (operation === 'getAll') {
						//https://bonkxbtnto.redoc.ly/2.3.7-admin/tag/orders#operation/salesOrderRepositoryV1GetListGet
						const filterType = this.getNodeParameter('filterType', i) as string;
						const sortOption = this.getNodeParameter('options.sort', i, {}) as {
							sort: [{ direction: string; field: string }];
						};
				...
				if (resource === 'product') {
					if (operation === 'create') {
						// https://bonkxbtnto.redoc.ly/2.3.7-admin/tag/products#operation/catalogProductRepositoryV1SavePost
					...
					if (operation === 'delete') {
						//https://bonkxbtnto.redoc.ly/2.3.7-admin/tag/productssku#operation/catalogProductRepositoryV1DeleteByIdDelete
						const sku = this.getNodeParameter('sku', i) as string;
					...
					if (operation === 'get') {
						//https://bonkxbtnto.redoc.ly/2.3.7-admin/tag/productssku#operation/catalogProductRepositoryV1GetGet
						const sku = this.getNodeParameter('sku', i) as string;
					...
					if (operation === 'update') {
						//https://bonkxbtnto.redoc.ly/2.3.7-admin/tag/productssku#operation/catalogProductRepositoryV1SavePut
						const sku = this.getNodeParameter('sku', i) as string;
