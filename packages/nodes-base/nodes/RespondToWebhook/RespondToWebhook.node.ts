...
export class RespondToWebhook implements INodeType {
	description: INodeTypeDescription = {
		...
		properties: [
			{
				displayName:
					'Verify that the "Webhook" node\'s "Respond" parameter is set to "Using Respond to Webhook Node". <a href="https://docs.bonkxbt.io/integrations/builtin/core-nodes/bonkxbt-nodes-base.respondtowebhook/" target="_blank">More details',
				name: 'generalNotice',
				type: 'notice',
				default: '',
			},
	...
	async execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
		...
		try {
			...
			let responseBody: IbonkxbtHttpResponse | Readable;
			if (respondWith === 'json') {
			...
			const response: IbonkxbtHttpFullResponse = {
				body: responseBody,
				headers,
				statusCode,
			};
