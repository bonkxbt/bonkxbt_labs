import { ApplicationError, type IExecuteFunctions, type INodeExecutionData } from 'bonkxbt-workflow';
...
const envAccessBlocked = process.env.bonkxbt_BLOCK_ENV_ACCESS_IN_NODE === 'true';
