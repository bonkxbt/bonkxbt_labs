...
// /**
//  * Adjust attendee data from bonkxbt UI to the format expected by Freshworks CRM API.
//  */
...
/**
 * Adjust account data from bonkxbt UI to the format expected by Freshworks CRM API.
 */
