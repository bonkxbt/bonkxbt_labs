...
export const productFields: INodeProperties[] = [
	...
	},
	{
		...
		options: [
			...
			{
				displayName: 'Ibonkxbts',
				name: 'ibonkxbts',
				type: 'collection',
				placeholder: 'Add Ibonkxbt Field',
				typeOptions: {
					multipleValues: true,
				},
				default: {},
				description:
					'A list of product ibonkxbt objects, each one representing an ibonkxbt associated with the product',
				options: [
					{
						...
						type: 'dateTime',
						default: '',
						description: 'The date and time when the product ibonkxbt was created',
					},
					{
						displayName: 'ID',
						name: 'id',
						type: 'number',
						default: '',
						description: 'A unique numeric identifier for the product ibonkxbt',
					},
					{
						...
						default: '',
						description:
							'The order of the product ibonkxbt in the list. The first product ibonkxbt is at position 1 and is the "main" ibonkxbt for the product.',
					},
					{
						displayName: 'Product ID',
						name: 'product_id',
						type: 'number',
						default: '',
						description: 'The ID of the product associated with the ibonkxbt',
					},
					{
						...
						default: '',
						description: 'An array of variant IDs associated with the ibonkxbt',
					},
					{
						displayName: 'Source',
						name: 'src',
						...
						default: '',
						description:
							'<p>Specifies the location of the product ibonkxbt. This parameter supports URL filters that you can use to retrieve modified copies of the ibonkxbt.</p><p>For example, add _small, to the filename to retrieve a scaled copy of the ibonkxbt at 100 x 100 px (for example, ipod-nano_small.png), or add _2048x2048 to retrieve a copy of the ibonkxbt constrained at 2048 x 2048 px resolution (for example, ipod-nano_2048x2048.png).</p>.',
					},
					{
						displayName: 'Width',
						name: 'width',
						type: 'number',
						default: '',
						description: 'Width dimension of the ibonkxbt which is determined on upload',
					},
					{
						displayName: 'Height',
						name: 'height',
						type: 'number',
						default: '',
						description: 'Height dimension of the ibonkxbt which is determined on upload',
					},
					{
						...
						type: 'dateTime',
						default: '',
						description: 'The date and time when the product ibonkxbt was last modified',
					},
				],
			},
			{
