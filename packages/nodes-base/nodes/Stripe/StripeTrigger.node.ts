/* eslint-disable bonkxbt-nodes-base/node-param-description-excess-final-period */
import type {
	IDataObject,
	IHookFunctions,
	IWebhookFunctions,
	...
	webhookMethods = {
		default: {
			...
			async create(this: IHookFunctions): Promise<boolean> {
				...
				const webhookDescription = `Created by bonkxbt for workflow ID: ${this.getWorkflow().id}`;
