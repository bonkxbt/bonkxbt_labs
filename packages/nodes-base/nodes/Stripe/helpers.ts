...
/**
 * Convert bonkxbt's address object into a Stripe API request shipping object.
 */
...
/**
 * Convert bonkxbt's `fixedCollection` metadata object into a Stripe API request metadata object.
 */
...
/**
 * Convert bonkxbt's shipping object into a Stripe API request shipping object.
 */
...
/**
 * Make bonkxbt's charge fields compliant with the Stripe API request object.
 */
export const adjustChargeFields = flow([adjustShipping, adjustMetadata]);

/**
 * Make bonkxbt's customer fields compliant with the Stripe API request object.
 */
