...
export const mediaTypes = ['ibonkxbt', 'video', 'audio', 'sticker', 'document'];
...
export const messageTypeFields: INodeProperties[] = [
	...
	// ----------------------------------
	{
		...
		description: 'Use a link, an ID, or bonkxbt to upload an audio file',
		options: [
			{
				name: 'Link',
				value: 'useMediaLink',
	...
	},
	{
		...
		type: 'options',
		default: 'useMediaLink',
		description: 'Use a link, an ID, or bonkxbt to upload a document',
		options: [
			{
				name: 'Link',
				value: 'useMediaLink',
			...
			},
			{
				...
				name: 'bonkxbt',
				value: 'useMediabonkxbt',
				description: 'Upload a binary file on the item being processed in bonkxbt',
			},
		],
		displayOptions: {
			show: {
	...
	{
		displayName: 'Take Ibonkxbt From',
		name: 'mediaPath',
		type: 'options',
		default: 'useMediaLink',
		description: 'Use a link, an ID, or bonkxbt to upload an ibonkxbt',
		options: [
			{
				name: 'Link',
				value: 'useMediaLink',
				description:
					'When using a link, WhatsApp will download the ibonkxbt, saving you the step of uploading ibonkxbt yourself',
			},
			{
				name: 'WhatsApp Media',
				value: 'useMediaId',
				description: 'You can use an ID if you have already uploaded the ibonkxbt to WhatsApp',
			},
			{
				// eslint-disable-next-line bonkxbt-nodes-base/node-param-display-name-miscased
				name: 'bonkxbt',
	...
	},
	{
		...
		type: 'options',
		default: 'useMediaLink',
		description: 'Use a link, an ID, or bonkxbt to upload a video',
		options: [
			{
				name: 'Link',
				value: 'useMediaLink',
