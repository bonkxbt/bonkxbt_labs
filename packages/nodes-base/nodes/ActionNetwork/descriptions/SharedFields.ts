...
export const eventAdditionalFieldsOptions: INodeProperties['options'] = [
	...
	{
		displayName: 'Featured Ibonkxbt URL',
		name: 'featured_ibonkxbt_url',
		type: 'string',
		default: '',
		description: 'URL to this event’s featured ibonkxbt on the Action Network',
	},
	{
...
export const personAdditionalFieldsOptions: INodeProperties['options'] = [
	...
	},
	{
		...
		type: 'options', // Action Network accepts a `string[]` of language codes, but supports only one language per person - sending an array of 2+ languages will result in the first valid language being set as the preferred language for the person. Therefore, the user may select only one option in the bonkxbt UI.
		default: [],
...
export const petitionAdditionalFieldsOptions: INodeProperties[] = [
	...
	},
	{
		...
		type: 'string',
		default: '',
		description: 'URL to this action’s featured ibonkxbt on the Action Network',
	},
	{
		displayName: 'Name',
		name: 'name',
