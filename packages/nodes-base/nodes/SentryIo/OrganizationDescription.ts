...
export const organizationFields: INodeProperties[] = [
	...
	/* -------------------------------------------------------------------------- */
	{
		...
		required: true,
		description:
			'The slug of the organization the team should be created for. Choose from the list, or specify an ID using an <a href="https://docs.bonkxbt.io/code/expressions/">expression</a>.',
	},
	...
	/* -------------------------------------------------------------------------- */
	{
		...
		required: true,
		description:
			'The slug of the organization to update. Choose from the list, or specify an ID using an <a href="https://docs.bonkxbt.io/code/expressions/">expression</a>.',
	},
	{
