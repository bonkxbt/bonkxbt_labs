...
describe('GraphQL Node', () => {
	...
	const baseUrl = 'https://api.bonkxbt.io/';
						...
						data: [
							{
								id: '1',
								attributes: {
									name: 'bonkxbt-nodes-base.activeCampaign',
										...
										data: {
											...
											resources: {
												primaryDocumentation: [
													{
														url: 'https://docs.bonkxbt.io/integrations/builtin/app-nodes/bonkxbt-nodes-base.activecampaign/',
													},
												],
												credentialDocumentation: [
													{
														url: 'https://docs.bonkxbt.io/integrations/builtin/credentials/activeCampaign/',
													},
												],
											},
