...
export const postFields: INodeProperties[] = [
	...
	},
	{
		...
		required: true,
		description:
			'Person as which the post should be posted as. Choose from the list, or specify an ID using an <a href="https://docs.bonkxbt.io/code/expressions/">expression</a>.',
		displayOptions: {
			show: {
				operation: ['create'],
				postAs: ['person'],
	...
	},
	{
		...
		options: [
			...
			},
			{
				name: 'Ibonkxbt',
				value: 'Ibonkxbt',
				description: 'The post contains an ibonkxbt',
			},
		],
		displayOptions: {
			show: {
		...
		options: [
			{
				...
				type: 'string',
				default: '',
				description: 'Provide a short description for your ibonkxbt or article',
				displayOptions: {
					show: {
			...
			},
			{
				...
				type: 'string',
				default: '',
				description: 'Customize the title of your ibonkxbt or article',
				displayOptions: {
					show: {
						'/shareMediaCategory': ['ARTICLE', 'Ibonkxbt'],
					},
				},
			},
			{
