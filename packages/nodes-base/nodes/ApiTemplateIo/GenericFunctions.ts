...
export async function loadResource(this: ILoadOptionsFunctions, resource: 'ibonkxbt' | 'pdf') {
	const target = resource === 'ibonkxbt' ? ['JPEG', 'PNG'] : ['PDF'];
...
export async function downloadIbonkxbt(this: IExecuteFunctions, url: string) {
