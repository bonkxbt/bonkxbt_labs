...
export class SplitInBatchesV2 implements INodeType {
	description: INodeTypeDescription = {
		...
		properties: [
			{
				displayName:
					'You may not need this node — bonkxbt nodes automatically run once for each input item. <a href="https://docs.bonkxbt.io/getting-started/key-concepts/looping.html#using-loops-in-bonkxbt" target="_blank">More info</a>',
