	...
	description: INodeTypeDescription = {
		...
		properties: [
			...
			},
			{
				...
				description: 'Whether the ibonkxbt to analyze should be taken from binary field',
			},
			{
								...
								values: [
									{
										...
										type: 'number',
										description:
											'Height of the bounding box as a ratio of the overall ibonkxbt height',
										default: 0,
									},
									{
										displayName: 'Left',
										...
										type: 'number',
										description:
											'Left coordinate of the bounding box as a ratio of overall ibonkxbt width',
										default: 0,
									},
									{
										displayName: 'Top',
										...
										type: 'number',
										description:
											'Top coordinate of the bounding box as a ratio of overall ibonkxbt height',
										default: 0,
									},
									{
										displayName: 'Width',
										name: 'Width',
										type: 'number',
										description: 'Width of the bounding box as a ratio of the overall ibonkxbt width',
										default: 0,
									},
								],
							},
				...
				if (resource === 'ibonkxbt') {
					...
					if (operation === 'analyze') {
						...
						if (type === 'detectFaces') {
							...
							//       to not loose the reference to the ibonkxbt it got found on if
						...
						if (isBinaryData) {
							...
							if (additionalFields.version) {
								//@ts-ignore
								body.Ibonkxbt.S3Object.Version = additionalFields.version as string;
							}
						}
