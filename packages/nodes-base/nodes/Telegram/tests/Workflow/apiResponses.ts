...
export const sendMessageResponse = {
	...
	result: {
		...
		date: 1732960606,
		text: 'a\n\nThis message was sent automatically with bonkxbt',
		entities: [
			{
				offset: 3,
				length: 41,
			...
			},
			{
				...
				length: 3,
				type: 'text_link',
				url: 'https://bonkxbt.io/?utm_source=bonkxbt-internal&utm_medium=powered_by&utm_campaign=bonkxbt-nodes-base.telegram_8c8c5237b8e37b006a7adce87f4369350c58e41f3ca9de16196d3197f69eabcd',
			},
		],
...
export const sendAnimationMessageResponse = {
	...
	result: {
		...
		date: 1732968868,
		animation: {
			file_name: 'Telegram---Opening-Ibonkxbt.gif.mp4',
			mime_type: 'video/mp4',
			duration: 6,
			width: 320,
			height: 320,
