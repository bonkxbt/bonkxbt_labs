...
import { BINARY_ENCODING, NodeConnectionType, NodeOperationError } from 'bonkxbt-workflow';
				...
				options: [
					{
						...
						description:
							'Whether to include the phrase “This message was sent automatically with bonkxbt” to the end of the message',
						displayOptions: {
							show: {
