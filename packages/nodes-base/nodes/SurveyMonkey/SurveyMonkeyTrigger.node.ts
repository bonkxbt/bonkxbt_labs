...
import { deepCopy, jsonParse, NodeConnectionType, NodeOperationError } from 'bonkxbt-workflow';
						...
						for (const question of questions) {
							...
							*/
							...
							if (question.family === 'presentation') {
								if (question.subtype === 'ibonkxbt') {
									const { url } = question.headings![0].ibonkxbt as IDataObject;
