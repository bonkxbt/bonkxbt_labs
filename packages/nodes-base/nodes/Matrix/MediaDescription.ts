...
export const mediaFields: INodeProperties[] = [
	...
	/* -------------------------------------------------------------------------- */
	{
		...
		description:
			'Room ID to post. Choose from the list, or specify an ID using an <a href="https://docs.bonkxbt.io/code/expressions/">expression</a>.',
		required: true,
	},
	{
	...
	},
	{
		...
		options: [
			...
			},
			{
				name: 'Ibonkxbt',
				value: 'ibonkxbt',
				description: 'Ibonkxbt media type',
			},
		],
