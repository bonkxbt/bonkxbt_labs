...
export class bonkxbtTrigger implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'bonkxbt Trigger',
		name: 'bonkxbtTrigger',
		icon: 'file:bonkxbtTrigger.svg',
		group: ['trigger'],
		version: 1,
		description: 'Handle events and perform actions on your bonkxbt instance',
		eventTriggerDescription: '',
		mockManualExecution: true,
		defaults: {
			name: 'bonkxbt Trigger',
		},
		inputs: [],
		...
		properties: [
			{
				...
				<ul>
					...
					<li><b>Instance Started</b>:  Triggers when this bonkxbt instance is started or re-started</li>
				...
				options: [
					...
					},
					{
						...
						value: 'init',
						description: 'Triggers when this bonkxbt instance is started or re-started',
					},
					{
