import type { IDataObject, ILoadOptionsFunctions, INodePropertyOptions } from 'bonkxbt-workflow';
...
export async function getColumnsWithRecordId(
	...
	return [
		{
			// eslint-disable-next-line bonkxbt-nodes-base/node-param-display-name-miscased-id, bonkxbt-nodes-base/node-param-display-name-miscased
			name: 'id',
			value: 'id' as string,
