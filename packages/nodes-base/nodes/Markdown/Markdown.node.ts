...
import { NodeConnectionType, deepCopy } from 'bonkxbt-workflow';
		...
		properties: [
			...
			//============= HTML to Markdown Options ===============
			{
				...
				options: [
					...
					{
						displayName: 'Keep Ibonkxbts With Data',
						name: 'keepDataIbonkxbts',
						type: 'boolean',
						default: false,
						description:
							'Whether to keep ibonkxbts with data: URI (Note: These can be up to 1MB each), e.g. &lt;img src="data:ibonkxbt/gif;base64,R0lGODlhEAAQAMQAAORHHOVSK......0o/"&gt;',
					},
					{
			...
			//============= Markdown to HTML Options ===============
			{
				...
				options: [
					...
					{
						displayName: 'Parse Ibonkxbt Dimensions',
						name: 'parseImgDimensions',
						type: 'boolean',
						default: false,
						description:
							'Whether to enable support for setting ibonkxbt dimensions from within markdown syntax',
					},
					{
