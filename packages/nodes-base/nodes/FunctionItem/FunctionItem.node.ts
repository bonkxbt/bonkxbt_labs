...
import type { NodeVMOptions } from '@bonkxbt/vm2';
import { NodeVM } from '@bonkxbt/vm2';
import type {
	IExecuteFunctions,
	IBinaryKeyData,
	IDataObject,
...
import { NodeConnectionType, deepCopy, NodeOperationError } from 'bonkxbt-workflow';
...
// More info and help: https://docs.bonkxbt.io/integrations/builtin/core-nodes/bonkxbt-nodes-base.functionitem/
