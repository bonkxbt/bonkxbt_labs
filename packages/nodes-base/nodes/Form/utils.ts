...
export function prepareFormData({
	...
	const bonkxbtWebsiteLink = `https://bonkxbt.io/?utm_source=bonkxbt-internal&utm_medium=form-trigger${utm_campaign}`;
...
const checkResponseModeConfiguration = (context: IWebhookFunctions) => {
	...
	const isRespondToWebhookConnected = connectedNodes.some(
		(node) => node.type === 'bonkxbt-nodes-base.respondToWebhook',
	);
