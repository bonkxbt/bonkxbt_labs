			...
			},
			{
				...
				modes: [
					...
					},
					{
						...
						name: 'url',
						type: 'string',
						placeholder: 'e.g. https://github.com/bonkxbt-io',
						extractValue: {
							type: 'regex',
			...
			},
			{
				...
				modes: [
					...
					},
					{
						...
						name: 'url',
						type: 'string',
						placeholder: 'e.g. https://github.com/bonkxbt-io/bonkxbt',
						extractValue: {
							type: 'regex',
				...
				options: [
					{
						...
						default: false,
						description:
							'Whether the SSL certificate of the bonkxbt host be verified by GitHub when delivering payloads',
					},
				],
			},
		],
			...
			async create(this: IHookFunctions): Promise<boolean> {
				...
				if (webhookUrl.includes('//localhost')) {
					throw new NodeOperationError(
						this.getNode(),
						'The Webhook can not work on "localhost". Please, either setup bonkxbt on a custom domain or start with "--tunnel"!',
					);
				}
