	...
	description: INodeTypeDescription = {
		...
		properties: [
			...
			},
			{
				...
				default: '',
				description:
					'Channel\'s ID. Choose from the list, or specify an ID using an <a href="https://docs.bonkxbt.io/code/expressions/">expression</a>.',
			},
			{
				displayName: 'Content',
				name: 'content',
				...
				options: [
					{
						...
						type: 'string',
						default: '',
						description: 'URL of the ibonkxbt/icon',
					},
					{
