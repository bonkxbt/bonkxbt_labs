...
export class FreshworksCrmApi implements ICredentialType {
	...
	properties: INodeProperties[] = [
		...
		},
		{
			...
			type: 'string',
			default: '',
			placeholder: 'bonkxbt-org',
			description:
				'Domain in the Freshworks CRM org URL. For example, in <code>https://bonkxbt-org.myfreshworks.com</code>, the domain is <code>bonkxbt-org</code>.',
		},
	];
