...
export const predefinedNodesTypes: INodeTypeData = {
	'bonkxbt-nodes-base.if': {
		type: new If(),
		sourcePath: '',
	},
	'bonkxbt-nodes-base.merge': {
		type: new Merge(),
		sourcePath: '',
	},
	'bonkxbt-nodes-base.noOp': {
		type: new NoOp(),
		sourcePath: '',
	},
	...
	'bonkxbt-nodes-base.splitInBatches': {
		type: new SplitInBatches(),
		sourcePath: '',
	},
	'bonkxbt-nodes-base.versionTest': {
		sourcePath: '',
		type: {
			description: {
			...
			workflowData: {
				nodes: [
					...
					},
					{
						...
						parameters: {},
						name: 'VersionTest1a',
						type: 'bonkxbt-nodes-base.versionTest',
						typeVersion: 1,
						position: [460, 300],
					},
					{
