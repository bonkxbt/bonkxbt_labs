...
import type { IDataObject, INode, INodeType } from 'bonkxbt-workflow';
import { jsonParse, NodeOperationError } from 'bonkxbt-workflow';
import { z } from 'zod';
...
// This file is temporarily duplicated in `packages/@bonkxbt/nodes-langchain/nodes/tools/ToolWorkflow/v2/utils/FromAIParser.ts`
