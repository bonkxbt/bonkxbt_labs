...
import { NodeHelpers, NodeApiError, NodeOperationError, sleep } from 'bonkxbt-workflow';
import type {
...
export class RoutingNode {
	...
	async runPostReceiveAction(
		...
		responseData: IbonkxbtHttpFullResponse,
	...
	async rawRoutingRequest(
		...
		credentialsDecrypted?: ICredentialsDecrypted,
	): Promise<IbonkxbtHttpFullResponse> {
		let responseData: IbonkxbtHttpFullResponse;
