...
import type { INodeParameters, INode, ITaskData, IDataObject, IConnections } from 'bonkxbt-workflow';

interface StubNode {
	name: string;
	parameters?: INodeParameters;
	disabled?: boolean;
	type?: 'bonkxbt-nodes-base.manualTrigger' | 'bonkxbt-nodes-base.splitInBatches' | (string & {});
}
...
export function createNodeData(stubData: StubNode): INode {
	return {
		...
		type: stubData.type ?? 'bonkxbt-nodes-base.set',
		typeVersion: 1,
		id: 'uuid-1234',
		position: [100, 100],
