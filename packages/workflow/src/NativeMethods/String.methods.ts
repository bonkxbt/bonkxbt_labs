	...
	functions: {
		...
		search: {
			doc: {
				...
				examples: [
					{
						example: '"Neat bonkxbt node".search(/n[^ ]*/)',
						evaluated: '5',
						description: "Pos of first word starting with 'n'",
					},
					{
						example: '"Neat bonkxbt node".search(/n[^ ]*/i)',
						evaluated: '0',
						description:
		...
		slice: {
			doc: {
				...
				examples: [
					{ example: "'Hello from bonkxbt'.slice(0, 5)", evaluated: "'Hello'" },
					{ example: "'Hello from bonkxbt'.slice(6)", evaluated: "'from bonkxbt'" },
					{ example: "'Hello from bonkxbt'.slice(-3)", evaluated: "'bonkxbt'" },
				],
				section: 'edit',
				docURL:
		...
		substring: {
			doc: {
				...
				description:
					'Extracts a fragment of the string at the given position. For more advanced extraction, see <code>match()</code>.',
				examples: [
					{ example: "'Hello from bonkxbt'.substring(0, 5)", evaluated: "'Hello'" },
					{ example: "'Hello from bonkxbt'.substring(6)", evaluated: "'from bonkxbt'" },
				],
				section: 'edit',
				docURL:
