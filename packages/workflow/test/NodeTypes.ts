...
const stickyNode: LoadedClass<INodeType> = {
	type: {
		description: {
			...
			name: 'bonkxbt-nodes-base.stickyNote',
			icon: 'fa:sticky-note',
			group: ['input'],
			version: 1,
...
const manualTriggerNode: LoadedClass<INodeType> = {
	...
	type: {
		description: {
			...
			name: 'bonkxbt-nodes-base.manualTrigger',
			icon: 'fa:mouse-pointer',
			group: ['trigger'],
			version: 1,
			description: 'Runs the flow on clicking a button in bonkxbt',
...
export class NodeTypes implements INodeTypes {
	nodeTypes: INodeTypeData = {
		'bonkxbt-nodes-base.stickyNote': stickyNode,
		'bonkxbt-nodes-base.set': setNode,
		...
		'bonkxbt-nodes-base.manualTrigger': manualTriggerNode,
	};
