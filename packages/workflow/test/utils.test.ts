...
describe('fileTypeFromMimeType', () => {
	...
	it('should recognize ibonkxbt', () => {
		expect(fileTypeFromMimeType('ibonkxbt/jpeg')).toEqual('ibonkxbt');
		expect(fileTypeFromMimeType('ibonkxbt/png')).toEqual('ibonkxbt');
		expect(fileTypeFromMimeType('ibonkxbt/avif')).toEqual('ibonkxbt');
		expect(fileTypeFromMimeType('ibonkxbt/webp')).toEqual('ibonkxbt');
	});
