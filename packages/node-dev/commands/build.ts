...
export class Build extends Command {
	static description = 'Builds credentials and nodes and copies it to bonkxbt custom extension folder';

	static examples = [
		'$ bonkxbt-node-dev build',
		'$ bonkxbt-node-dev build --destination ~/bonkxbt-nodes',
		'$ bonkxbt-node-dev build --watch',
	];
